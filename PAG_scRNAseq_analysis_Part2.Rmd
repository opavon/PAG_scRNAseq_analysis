...
```{r}
# Plot Expression values of EYFP and tdTomato
plotExpression(PAG_sceset, c("EYFP", "tdTomato"), x="mouse.id", 
               exprs_values = "counts",
               log2_values = TRUE,
               colour_by = "cell.fluorophor")

plotExpression(PAG_sceset, c("Slc17a6", "Slc32a1"), x="mouse.id", 
               exprs_values = "counts",
               log2_values = TRUE,
               colour_by = "cell.fluorophor")
...
plotExpression(PAG_sceset[, (PAG_sceset$cell.fluorophor=="tdTomato")], "EYFP", x="tdTomato", 
               exprs_values = "counts",
               log2_values = TRUE,
               colour_by = "EYFP",
               xlab = "tdTomato counts in tdTomato cells")
...
### 2.3.4 | VGAT/VGluT2 ratio
We isolated cells from transgenic animals expressing either EYFP or tdTomato as a reporter under VGAT or VGluT2. Do they only express one or the other, or do some cells express both? If so, in which proportions? We can look at this the same way we looked at EYFP and tdTomato ratios.
```{r}
...
```{r}
# Plot Expression values of VGAT and VGluT2
...
VGAT <- subset(PAG_sceset, , cell.type=="VGAT")
plotExpression(VGAT, "Slc32a1", x="Slc17a6", 
               exprs_values = "counts",
               xlab = "VGluT2 counts in VGAT cells")

VGluT2 <- subset(PAG_sceset, , cell.type=="VGluT2")
plotExpression(VGluT2, "Slc32a1", x="Slc17a6", 
               exprs_values = "counts",
               xlab = "VGluT2 counts in VGluT2 cells"
               )
