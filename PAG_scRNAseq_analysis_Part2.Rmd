...
flurophor_expression_EYFPanimals <- plotExpression(PAG_sceset[, PAG_sceset$cell.fluorophor == "EYFP"], c("EYFP", "tdTomato", "Cre"), x = "mouse.id",
                                                   exprs_values = "logcounts_raw", # alternatively try "counts"
                                                   colour_by = "batch.processing", ncol = 3, theme_size = 10, point_alpha = 0.8) +
  ggtitle("Transgene expression levels in Cre::EYFP animals") + xlab("Mouse ID") + ylab("Expression (log2 raw counts)")

flurophor_expression_EYFPanimals
ggsave(filename = str_c(date, "_flurophor_expression_EYFPanimals.pdf"),
       plot = flurophor_expression_EYFPanimals,
...
flurophor_expression_tdTomatoanimals <- plotExpression(PAG_sceset[, PAG_sceset$cell.fluorophor == "tdTomato"], c("EYFP", "tdTomato", "Cre"), x = "mouse.id",
                                                       exprs_values = "logcounts_raw", # alternatively try "counts"
                                                       colour_by = "batch.processing", ncol = 3, theme_size = 10, point_alpha = 0.8) +
  ggtitle("Transgene expression levels in Cre::tdTomato animals") + xlab("Mouse ID") + ylab("Expression (log2 raw counts)")

flurophor_expression_tdTomatoanimals
ggsave(filename = str_c(date, "_flurophor_expression_tdTomatoanimals.pdf"),
       plot = flurophor_expression_tdTomatoanimals,
       device = "pdf", # or one of "eps", "ps", "tex" (pictex), "pdf", "jpeg", "tiff", "png", "bmp", "svg" or "wmf" (windows only).
       path = path_for_figures,
...
plotExpression(PAG_sceset, c("EYFP", "tdTomato"), x = "cell.fluorophor", 
               exprs_values = "logcounts_raw", # alternatively try "counts"
               colour_by = "mouse.id", 
               xlab = "Cell fluorophor") + ylab("Expression (log2 raw counts)")
...
# # Another way of doing the same without creating a new slot in colData:
# # In EYFP cells, plot the EYFP log2 total counts against the tdTomato counts
# plot(assay(PAG_sceset[rownames(PAG_sceset)=="EYFP", PAG_sceset$cell.fluorophor == "EYFP"], "logcounts_raw"),
#      assay(PAG_sceset[rownames(PAG_sceset)=="tdTomato", PAG_sceset$cell.fluorophor == "EYFP"], "logcounts_raw"),
...
# 
# # Add the equivalent plot for tdTomato cells
# points(assay(PAG_sceset[rownames(PAG_sceset)=="EYFP", PAG_sceset$cell.fluorophor == "tdTomato"], "logcounts_raw"),
#        assay(PAG_sceset[rownames(PAG_sceset)=="tdTomato", PAG_sceset$cell.fluorophor == "tdTomato"], "logcounts_raw"),
#        type = "p", pch = 19, cex = 1,
#        col = rgb(255, 0, 0, 255/6, maxColorValue = 255))
```
...
plotExpression(PAG_sceset[, PAG_sceset$cell.type == "VGAT"], c("Slc32a1", "Slc17a6"), x = "mouse.id", 
  ...
  ggtitle("Transporter expression levels VGAT::Cre animals") + xlab("Mouse ID") + ylab("Expression (log2 raw counts)")

plotExpression(PAG_sceset[, PAG_sceset$cell.type == "VGluT2"], c("Slc32a1", "Slc17a6"), x = "mouse.id", 
               exprs_values = "logcounts_raw", # alternatively try "counts"
               colour_by = "batch.processing", ncol = 2, theme_size = 10, point_alpha = 0.8) +
  ggtitle("Transporter expression levels VGluT2::Cre animals") + xlab("Mouse ID") + ylab("Expression (log2 raw counts)")

plotExpression(PAG_sceset, c("Slc32a1", "Slc17a6"), x = "cell.type", 
               exprs_values = "logcounts_raw", # alternatively try "counts"
               colour_by = "mouse.id", 
               xlab = "Cell type") + ylab("Expression (log2 raw counts)")
...
# Save the plot
ggsave(filename = str_c(date, "_venn_summary_cellQC_filters.pdf"),
...
cell_QC_summary <- gridExtra::grid.arrange(plotColData(PAG_sceset, x = "cell.type", y = "total_million", 
                                           ...
                                           plotColData(PAG_sceset, x = "cell.type", y = "percent_top_100",
                                             ...
                                             scale_colour_manual(name = "Excluded", values = c("grey", "red"), aesthetics = c("colour", "fill")),
                                           plotColData(PAG_sceset, x = "cell.fluorophor", y = "log2_total_counts_EYFP",
                                             ...
                                             scale_colour_manual(name = "Excluded", values = c("grey", "red"), aesthetics = c("colour", "fill")),
                                           plotColData(PAG_sceset, x = "cell.fluorophor", y = "log2_total_counts_tdTomato",
...
# Save the plot
ggsave(filename = str_c(date, "_cell_QC_summary.pdf"),
...
cell_QC_summary_all <- gridExtra::grid.arrange(plotColData(PAG_sceset, x = "cell.type", y = "total_million",
                                                 ...
                                                 ggtitle("Library size") + xlab(NULL) + ylab("Total reads (millions)") +
                                                 scale_colour_manual(name = "use", values = c("red","grey"), aesthetics = c("colour", "fill")),
                                               plotColData(PAG_sceset, x = "cell.type", y = "detected",
                                                           colour_by = "use", theme_size = 10, point_alpha = 0.8) + 
                                                 ggtitle("Detected genes") + xlab(NULL) + ylab("Number of genes detected") + 
                                                 scale_colour_manual(name = "use", values = c("red","grey"), aesthetics = c("colour", "fill")),
...
# Save the plot
ggsave(filename = str_c(date, "_cell_QC_summary_all.pdf"),
