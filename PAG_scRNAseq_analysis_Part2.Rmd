...
violin_fluorophores_EYFPbymouse_counts <- plotExpression(PAG_sceset[, PAG_sceset$cell.fluorophore == "EYFP"], c("EYFP", "tdTomato", "Cre"), x = "mouse.id",
                                                         exprs_values = "counts",
                                                         colour_by = "batch.processing", ncol = 3, theme_size = 10, point_alpha = 0.8) +
  ggtitle("Transgene expression levels in cells from Cre::EYFP animals (raw counts)") + xlab("Mouse ID") + ylab("Expression (raw counts)") + 
...
violin_fluorophores_EYFPbymouse_logcounts_raw <- plotExpression(PAG_sceset[, PAG_sceset$cell.fluorophore == "EYFP"], c("EYFP", "tdTomato", "Cre"), x = "mouse.id",
                                                                ...
                                                                colour_by = "batch.processing", ncol = 3, theme_size = 10, point_alpha = 0.8) +
  ggtitle("Transgene expression levels in cells from Cre::EYFP animals (log2 raw counts)") + xlab("Mouse ID") + ylab("Expression (log2 raw counts)") + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
violin_fluorophores_tdTomatobymouse_counts <- plotExpression(PAG_sceset[, PAG_sceset$cell.fluorophore == "tdTomato"], c("EYFP", "tdTomato", "Cre"), x = "mouse.id",
                                                             exprs_values = "counts",
                                                             colour_by = "batch.processing", ncol = 3, theme_size = 10, point_alpha = 0.8) +
  ggtitle("Transgene expression levels in cells from Cre::tdTomato animals (raw counts)") + xlab("Mouse ID") + ylab("Expression (raw counts)") + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
violin_fluorophores_tdTomatobymouse_logcounts_raw <- plotExpression(PAG_sceset[, PAG_sceset$cell.fluorophore == "tdTomato"], c("EYFP", "tdTomato", "Cre"), x = "mouse.id",
                                                                    exprs_values = "logcounts_raw",
                                                                    colour_by = "batch.processing", ncol = 3, theme_size = 10, point_alpha = 0.8) +
  ggtitle("Transgene expression levels in cells from Cre::tdTomato animals (log2 raw counts)") + xlab("Mouse ID") + ylab("Expression (log2 raw counts)") + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
violin_fluorophores_celltype_counts <- plotExpression(PAG_sceset, c("EYFP", "tdTomato"), x = "cell.fluorophore",
                                                      exprs_values = "counts", 
                                                      colour_by = "mouse.id", ncol = 2, theme_size = 10, point_alpha = 0.8) +
...
violin_fluorophores_celltype_logcounts_raw <- plotExpression(PAG_sceset, c("EYFP", "tdTomato"), x = "cell.fluorophore",
                                                             exprs_values = "logcounts_raw", 
                                                             colour_by = "mouse.id", ncol = 2, theme_size = 10, point_alpha = 0.8) +
  ggtitle("Transporter expression levels in cells from VGluT2::Cre animals (log2 raw counts)") + xlab("Fluorophore") + ylab("Expression (log2 raw counts)")
...
# Save the plot
pdf(file = str_c(path_for_figures, date, "_scatter_fluorophore_expression.pdf"),
...
violin_VGATVGluT2_VGATbymouse_counts <- plotExpression(PAG_sceset[, PAG_sceset$cell.type == "VGAT"], c("Slc32a1", "Slc17a6"), x = "mouse.id",
                                                       exprs_values = "counts",
                                                       colour_by = "batch.processing", ncol = 2, theme_size = 10, point_alpha = 0.8) +
...
violin_VGATVGluT2_celltype_counts <- plotExpression(PAG_sceset, c("Slc32a1", "Slc17a6"), x = "cell.type",
                                                    exprs_values = "counts", 
                                                    colour_by = "mouse.id", ncol = 2, theme_size = 10, point_alpha = 0.8) +
  ggtitle("Transporter expression levels in cells from VGluT2::Cre animals (raw counts)") + xlab("Cell type") + ylab("Expression (raw counts)")
...
violin_VGATVGluT2_celltype_logcounts_raw <- plotExpression(PAG_sceset, c("Slc32a1", "Slc17a6"), x = "cell.type",
                                                           exprs_values = "logcounts_raw", 
                                                           colour_by = "mouse.id", ncol = 2, theme_size = 10, point_alpha = 0.8) +
  ggtitle("Transporter expression levels in cells from VGluT2::Cre animals (log2 raw counts)") + xlab("Cell type") + ylab("Expression (log2 raw counts)")
...
# Save the plot
pdf(file = str_c(path_for_figures, date, "_scatter_VGATVGluT2_expression.pdf"),
    width = 12, height = 9, pointsize = 12,
    family = "Helvetica", bg = "transparent")
plot(assay(PAG_sceset[rownames(PAG_sceset)=="Slc32a1", PAG_sceset$cell.type == "VGAT"], "counts"),
     assay(PAG_sceset[rownames(PAG_sceset)=="Slc17a6", PAG_sceset$cell.type == "VGAT"], "counts"),
...
cell_QC_summary <- gridExtra::grid.arrange(plotColData(PAG_sceset, x = "cell.type", y = "total_million", 
                                                       colour_by = "filter_by_total_counts_manual", theme_size = 10, point_alpha = 0.8) + 
                                           ...
                                           plotColData(PAG_sceset, x = "cell.type", y = "detected",
                                                       colour_by = "filter_by_expr_features_manual", theme_size = 10, point_alpha = 0.8) + 
                                           ...
                                           plotColData(PAG_sceset, x = "cell.type", y = "subsets_Mitochondrial_percent",
                                                       colour_by = "filter_by_pct_Mitochondrial_manual", theme_size = 10, point_alpha = 0.8) + 
                                           ...
                                           plotColData(PAG_sceset, x = "cell.type", y = "subsets_Ribosomal_percent",
                                                       colour_by = "filter_by_pct_Ribosomal_manual", theme_size = 10, point_alpha = 0.8) +
                                           ...
                                           plotColData(PAG_sceset, x = "cell.type", y = "altexps_ERCC_percent",
                                                       colour_by = "filter_by_pct_ERCC_manual", theme_size = 10, point_alpha = 0.8) + 
                                           ...
                                           plotColData(PAG_sceset, x = "cell.type", y = "subsets_TSO_concatamers_percent",
                                                       colour_by = "filter_by_pct_TSO_concatamer_manual", theme_size = 10, point_alpha = 0.8) + 
                                           ...
                                           plotColData(PAG_sceset, x = "cell.type", y = "percent_top_100",
                                                       colour_by = "filter_by_percent_top_100_manual", theme_size = 10, point_alpha = 0.8) + 
                                           ...
                                           plotColData(PAG_sceset, x = "cell.fluorophore", y = "log2_total_counts_EYFP",
                                                       colour_by = "filter_by_wrong_flurorophor_tdTomato_cells", theme_size = 10, point_alpha = 0.8) + 
                                           ...
                                           plotColData(PAG_sceset, x = "cell.fluorophore", y = "log2_total_counts_tdTomato",
                                                       colour_by = "filter_by_wrong_flurorophor_EYFP_cells", theme_size = 10, point_alpha = 0.8) + 
...
cell_QC_summary_all <- gridExtra::grid.arrange(plotColData(PAG_sceset, x = "cell.type", y = "total_million",
                                                           colour_by = "use", theme_size = 10, point_alpha = 0.8) + 
                                                 ggtitle("Library size") + xlab(NULL) + ylab("Total reads (millions)") +
