...
hist(PAG_sceset$subsets_TSO_concatamers_percent,
     breaks = 50,
     xlab = "TSO concatamers proportion (%)", ylab = "Number of cells", main = "TSO concatamers", col = "grey80")
...
summary(PAG_sceset[,PAG_sceset$filter_by_pct_TSO_concatamer_manual]$PAG.area)
...
violin_cell_QC_TSO <- plotColData(PAG_sceset, x = "cell.type", y = "subsets_TSO_concatamers_percent",
                                  colour_by = "filter_by_pct_TSO_concatamer_manual", theme_size = 11, point_alpha = 0.8) + 
  ggtitle("TSO concatamers") + xlab(NULL) + ylab("% of total reads") + theme_args_violin_summary +
  scale_colour_manual(name = "Excluded", values = c("grey", "red"), aesthetics = c("colour", "fill"))
...
#                                              scale_colour_manual(name = "Excluded", values = c("grey", "red"), aesthetics = c("colour", "fill")),
#                                            plotColData(PAG_sceset, x = "cell.type", y = "subsets_TSO_concatamers_percent",
#                                                        colour_by = "filter_by_pct_TSO_concatamer_manual", theme_size = 11, point_alpha = 0.8) + 
#                                              ggtitle("Percent reads in TSO concatamers") + xlab(NULL) + ylab("% reads in TSO concatamers") + 
#                                              scale_colour_manual(name = "Excluded", values = c("grey", "red"), aesthetics = c("colour", "fill")),
