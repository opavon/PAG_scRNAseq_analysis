...
### 2.1.1 | Uniquify feature names [skip for now]
...
We can continue working with ENSEMBL IDs, so we will skip this step for now.
...
plotExpression(PAG_sceset, "EYFP", x="cell.fluorophor", 
               exprs_values = "counts", 
               colour_by = "PAG.areacollection")

plotExpression(PAG_sceset, "tdTomato", x="cell.fluorophor", 
               exprs_values = "counts", 
               colour_by = "PAG.areacollection")
...
plotExpression(PAG_sceset, "Slc32a1", x="cell.type", 
               exprs_values = "counts", 
               colour_by = "PAG.areacollection")

plotExpression(PAG_sceset, "Slc17a6", x="cell.type", 
               exprs_values = "counts", 
               colour_by = "PAG.areacollection")
...
```{r}
# Change the gene names from ENSEMBL IDs to Gene Symbols to facilitate interpretation
