...
abline(v = 40, col = "blue", lwd=2, lty=2)
```
...
plot(PAG_sceset[, PAG_sceset$cell.fluorophor=="EYFP"]$total_counts_EYFP,
     ...
     xlim = c(0, max(PAG_sceset$total_counts_EYFP)),
     ylim = c(0, max(PAG_sceset$total_counts_tdTomato)),
...
PAG_sceset$filter_by_total_counts_manual <- (PAG_sceset$total_counts < 40.e4)
...
PAG_sceset$filter_by_expr_features_manual <- (PAG_sceset$total_features_by_counts < 5000) 
...
PAG_sceset$filter_by_pct_ERCC_manual <- (PAG_sceset$pct_counts_ERCC > 1) 
...
PAG_sceset$filter_by_pct_Mitochondrial_manual <- (PAG_sceset$pct_counts_Mitochondrial > 15) 
...
PAG_sceset$filter_by_pct_Ribosomal_manual <- (PAG_sceset$pct_counts_Ribosomal > 30)
table(PAG_sceset$filter_by_pct_Ribosomal_manual)
summary(PAG_sceset[,PAG_sceset$filter_by_pct_Ribosomal_manual]$PAG.areacollection)

# Less than 5% of counts in TSO concatamers
PAG_sceset$filter_by_pct_TSO_concatamer_manual <- (PAG_sceset$pct_counts_TSO_concatamers > 5)
...
PAG_sceset$filter_by_pct_counts_feature_control_manual <- (PAG_sceset$pct_counts_feature_control > 40)
table(PAG_sceset$filter_by_pct_counts_feature_control_manual)
summary(PAG_sceset[,PAG_sceset$filter_by_pct_counts_feature_control_manual]$PAG.areacollection)
...
# Custom filters: identify the cells that have no expression of the expected fluorophor and express the wrong oneand not expressing any fluorophor
PAG_sceset$filter_by_wrong_flurorophor_EYFP_cells <- PAG_sceset$cell.fluorophor=="EYFP" & PAG_sceset$log2_total_counts_tdTomato > 0
...
PAG_sceset$filter_by_wrong_flurorophor_tdTomato_cells <- PAG_sceset$cell.fluorophor=="tdTomato" & PAG_sceset$log2_total_counts_EYFP > 0
...
# Custom filters: also label the cells not expressing any fluorophor, although they are likely to be dropout events we can use them in combination of other filter
PAG_sceset$cells_nofluorophor <- PAG_sceset$log2_total_counts_EYFP == 0 & PAG_sceset$log2_total_counts_tdTomato == 0
...
PAG_sceset$filter_by_wrong_transporter_VGAT_cells <- PAG_sceset$cell.type=="VGAT" & PAG_sceset$cells_nofluorophor==TRUE & PAG_sceset$log2_total_counts_VGAT == 0 & PAG_sceset$log2_total_counts_VGluT2 > 0
...
PAG_sceset$filter_by_wrong_transporter_VGluT2_cells <- PAG_sceset$cell.type=="VGluT2" & PAG_sceset$cells_nofluorophor==TRUE & PAG_sceset$log2_total_counts_VGAT > 0 & PAG_sceset$log2_total_counts_VGluT2 == 0
...
PAG_sceset$cells_noVGAT_noVGluT2 <- PAG_sceset$log2_total_counts_VGAT == 0 & PAG_sceset$log2_total_counts_VGluT2 == 0 & PAG_sceset$cells_nofluorophor==TRUE 
...
PAG_sceset$manual_filters <- !(
    ...
    PAG_sceset$filter_by_pct_Ribosomal_manual |
    ...
    PAG_sceset$filter_by_pct_counts_feature_control_manual |
...
data.frame(ByLibSize=sum(PAG_sceset$filter_by_total_counts_manual), 
           ...
           ByRibosomal=sum(PAG_sceset$filter_by_pct_Ribosomal_manual),
           ByTSOconcatamer=sum(PAG_sceset$filter_by_pct_TSO_concatamer_manual),
           ByCtrlFeatures=sum(PAG_sceset$filter_by_pct_counts_feature_control_manual),
...
summary(PAG_sceset[,!PAG_sceset$manual_filters]$PAG.areacollection)
summary(PAG_sceset[,PAG_sceset$manual_filters]$PAG.areacollection)
summary(PAG_sceset[,!PAG_sceset$manual_filters]$PAG.arearegistration)
summary(PAG_sceset[,PAG_sceset$manual_filters]$PAG.arearegistration)
summary(PAG_sceset[,!PAG_sceset$manual_filters]$cell.type)
summary(PAG_sceset[,PAG_sceset$manual_filters]$cell.type)
```
...
plyr::ldply(list(ByLibSize=colnames(PAG_sceset[, PAG_sceset$filter_by_total_counts_manual]),
                 ...
                 ByRibosomal=colnames(PAG_sceset[, PAG_sceset$filter_by_pct_Ribosomal_manual]),
                 ByTSOconcatamer=colnames(PAG_sceset[, PAG_sceset$filter_by_pct_TSO_concatamer_manual]),
                 ByCtrlFeatures=colnames(PAG_sceset[, PAG_sceset$filter_by_pct_counts_feature_control_manual]),
...
```{r}
# Total counts
PAG_sceset$filter_by_total_counts_MADs <- isOutlier(PAG_sceset$total_counts, nmads = 5, type = "lower", log = TRUE, batch = NULL)
table(PAG_sceset$filter_by_total_counts_MADs)

# Expressed features
PAG_sceset$filter_by_expr_features_MADs <- isOutlier(PAG_sceset$total_features_by_counts, nmads = 5, type = "lower", log = TRUE, batch = NULL)
...
```{r}
# ERCCs
PAG_sceset$filter_by_pct_ERCC_MADs <- isOutlier(PAG_sceset$pct_counts_ERCC, nmads = 5, type = "higher", batch = NULL)
table(PAG_sceset$filter_by_pct_ERCC_MADs)

# Mitochondrial genes
PAG_sceset$filter_by_pct_Mitochondrial_MADs <- isOutlier(PAG_sceset$pct_counts_Mitochondrial, nmads = 5, type = "higher", batch = NULL)
table(PAG_sceset$filter_by_pct_Mitochondrial_MADs)

# Ribosomal genes
PAG_sceset$filter_by_pct_Ribosomal_MADs <- isOutlier(PAG_sceset$pct_counts_Ribosomal, nmads = 5, type = "higher", batch = NULL)
table(PAG_sceset$filter_by_pct_Ribosomal_MADs)

# TSO concatamers
PAG_sceset$filter_by_pct_TSO_concatamer_MADs <- isOutlier(PAG_sceset$pct_counts_TSO_concatamers, nmads = 5, type = "higher", batch = NULL)
table(PAG_sceset$filter_by_pct_TSO_concatamer_MADs)

# Control features
PAG_sceset$filter_by_pct_counts_feature_control_MADs <- isOutlier(PAG_sceset$pct_counts_feature_control, nmads = 5, type = "higher", batch = NULL)
table(PAG_sceset$filter_by_pct_counts_feature_control_MADs)
```
...
PAG_sceset$MADs_filters <- !(
    ...
    # Remove cells with unusual proportion of reads in control features
    PAG_sceset$filter_by_pct_counts_feature_control_MADs
)
...
data.frame(ByLibSize=sum(PAG_sceset$filter_by_total_counts_MADs), 
           ...
           ByCtrlFeatures=sum(PAG_sceset$filter_by_pct_counts_feature_control_MADs),
...
plotHighestExprs(PAG_sceset, n = 100, colour_cells_by = "cell.type")
plotHighestExprs(PAG_sceset[ , colData(PAG_sceset)$use], n = 100, colour_cells_by = "cell.type")
...
rowData(PAG_sceset)$genes_expressed <- use_numcells >= 1 # This will leave genes expressed in less than X number of cells as FALSE
...
rowData(PAG_sceset)$filter_predictedgenes_noexpression <- (rowData(PAG_sceset)$genes_expressed & rowData(PAG_sceset)$not_predicted_gene) # We will keep only the genes that are both expressed in at least X cells and NOT predicted genes.
summary(rowData(PAG_sceset)$filter_predictedgenes_noexpression)
```

```{r}
# Assign the chosen list of filtered genes to $use slot corresponding to the rows (genes):
rowData(PAG_sceset)$use <- rowData(PAG_sceset)$filter_predictedgenes_noexpression
table(rowData(PAG_sceset)$filter_predictedgenes_noexpression)
