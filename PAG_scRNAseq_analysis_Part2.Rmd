...
PAG_sceset$filter_by_wrong_flurorophor_EYFP_cells <- (PAG_sceset$cell.fluorophore == "EYFP" & PAG_sceset$subsets_tdTomato_sum > 0)
...
PAG_sceset$filter_by_wrong_flurorophor_tdTomato_cells <- (PAG_sceset$cell.fluorophore == "tdTomato" & PAG_sceset$subsets_EYFP_sum > 0)
...
summary(PAG_sceset[,PAG_sceset$cells_nofluorophore]$PAG.areacollection)
...
violin_cell_QC_EYFP <- plotColData(PAG_sceset, x = "cell.fluorophore", y = "log2_total_counts_EYFP",
                                   colour_by = "filter_by_wrong_flurorophor_tdTomato_cells", theme_size = 12, point_alpha = 0.8) + 
...
violin_cell_QC_tdTomato <- plotColData(PAG_sceset, x = "cell.fluorophore", y = "log2_total_counts_tdTomato",
                                       colour_by = "filter_by_wrong_flurorophor_EYFP_cells", theme_size = 12, point_alpha = 0.8) + 
