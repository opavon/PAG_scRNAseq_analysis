...
`scater` allows us to define control features (genes) that we can use for quality checks, such as ERCC spike-ins if we have them, Mitochondrial and Ribosomal genes, and any fluorophores used to identify the cells if they come from transgenic animals. 
