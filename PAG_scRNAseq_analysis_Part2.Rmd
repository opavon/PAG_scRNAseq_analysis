...
filter_patchseq_cells <- (PAG_sceset_qc_norm$patch.recorded == "yes")
filter_AQ_cells <- (PAG_sceset_qc_norm$cell.id == "AQ")
...
is_predicted_gene <- grepl("^Gm", rownames(PAG_sceset))

filter_genes <- ((use_numcells >= 1) | is_predicted_gene) # Try 5 cells (1% of dataset)
