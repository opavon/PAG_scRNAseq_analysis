...
PAG_sceset$VGAT_VGluT2_expression[(which(PAG_sceset$cell.type == "VGAT" & PAG_sceset$subsets_VGluT2_sum == 0))] <- "VGAT_only"
PAG_sceset$VGAT_VGluT2_expression[(which(PAG_sceset$cell.type == "VGAT" & PAG_sceset$subsets_VGluT2_sum > 0))] <- "VGAT_VGluT2"
PAG_sceset$VGAT_VGluT2_expression[(which(PAG_sceset$cell.type == "VGluT2" & PAG_sceset$subsets_VGAT_sum == 0))] <- "VGluT2_only"
PAG_sceset$VGAT_VGluT2_expression[(which(PAG_sceset$cell.type == "VGluT2" & PAG_sceset$subsets_VGAT_sum > 0))] <- "VGluT2_VGAT"
