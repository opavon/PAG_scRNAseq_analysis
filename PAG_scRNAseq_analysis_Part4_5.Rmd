...
tSNE_HVG_var_logcounts_5 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_var_logcounts_10 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_var_logcounts_15 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_var_logcounts_20 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_var_logcounts_30 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_var_logcounts_40 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_var_logcounts_50 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_var_logcounts_75 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_var_logcounts_100 <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                             dimred = "tSNE_perplexity_100",
                                             colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                             shape_by = "cell.type"#, # "mouse.id"
                                             #size_by = "detected"
                                             ) + ggtitle("tSNE_perplexity_100") #+ coord_cartesian(xlim = c(-35, 35), ylim = c(-35, 35))

multiplot(tSNE_HVG_var_logcounts_5, tSNE_HVG_var_logcounts_10, tSNE_HVG_var_logcounts_15, tSNE_HVG_var_logcounts_20, 
          tSNE_HVG_var_logcounts_30, tSNE_HVG_var_logcounts_40, tSNE_HVG_var_logcounts_50, tSNE_HVG_var_logcounts_75, 
          cols = 2)
```

Repeat using the PCA results obtained with `HVG_cv2_logcounts`:
```{r}
# Compute tSNE with different perplexities:
set.seed(1991)
range_of_perplexities = list(5, 10, 15, 20, 30, 40, 50, 75) # N^1/2 shouldn't be far off
...
tSNE_HVG_cv2_logcounts_5 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_cv2_logcounts_10 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_cv2_logcounts_15 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_cv2_logcounts_20 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_cv2_logcounts_30 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_cv2_logcounts_40 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_cv2_logcounts_50 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
tSNE_HVG_cv2_logcounts_75 <- plotReducedDim(PAG_sceset_qc_norm_filt,
...
multiplot(tSNE_HVG_cv2_logcounts_5, tSNE_HVG_cv2_logcounts_10, tSNE_HVG_cv2_logcounts_15, tSNE_HVG_cv2_logcounts_20,
          tSNE_HVG_cv2_logcounts_30, tSNE_HVG_cv2_logcounts_40, tSNE_HVG_cv2_logcounts_50, tSNE_HVG_cv2_logcounts_75, cols = 2)
```
...
for(j in range_of_neighbors) {
  for (k in range_of_min_dist) {
    PAG_sceset_qc_norm_filt <- runUMAP(PAG_sceset_qc_norm_filt,
                                       ...
                                       name = paste0("UMAP_var_logcounts_", j, "_neighbors_", k, "_min_dist"))
  }
}
...
#### n_neighbors = 5
UMAP_var_logcounts_5_neighbors_0.01_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_var_logcounts_5_neighbors_0.01_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_var_logcounts_5_neighbors_0.01_min_dist")
UMAP_var_logcounts_5_neighbors_0.05_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_var_logcounts_5_neighbors_0.05_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_var_logcounts_5_neighbors_0.05_min_dist")
UMAP_var_logcounts_5_neighbors_0.1_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                              dimred = "UMAP_var_logcounts_5_neighbors_0.1_min_dist",
                                                              colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                              shape_by = "cell.type"#, # "mouse.id"
                                                              #size_by = "detected"
                                                              ) + ggtitle("UMAP_var_logcounts_5_neighbors_0.1_min_dist")
UMAP_var_logcounts_5_neighbors_0.2_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_var_logcounts_5_neighbors_0.2_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_var_logcounts_5_neighbors_0.2_min_dist")

#### n_neighbors = 10
UMAP_var_logcounts_10_neighbors_0.01_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                                dimred = "UMAP_var_logcounts_10_neighbors_0.01_min_dist",
                                                                colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                                shape_by = "cell.type"#, # "mouse.id"
                                                                #size_by = "detected"
                                                                ) + ggtitle("UMAP_var_logcounts_10_neighbors_0.01_min_dist")
UMAP_var_logcounts_10_neighbors_0.05_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                                dimred = "UMAP_var_logcounts_10_neighbors_0.05_min_dist",
                                                                colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                                shape_by = "cell.type"#, # "mouse.id"
                                                                #size_by = "detected"
                                                                ) + ggtitle("UMAP_var_logcounts_10_neighbors_0.05_min_dist")
UMAP_var_logcounts_10_neighbors_0.1_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_var_logcounts_10_neighbors_0.1_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_var_logcounts_10_neighbors_0.1_min_dist")
UMAP_var_logcounts_10_neighbors_0.2_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_var_logcounts_10_neighbors_0.2_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_var_logcounts_10_neighbors_0.2_min_dist")

#### n_neighbors = 15
UMAP_var_logcounts_15_neighbors_0.01_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                                dimred = "UMAP_var_logcounts_15_neighbors_0.01_min_dist",
                                                                colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                                shape_by = "cell.type"#, # "mouse.id"
                                                                #size_by = "detected"
                                                                ) + ggtitle("UMAP_var_logcounts_15_neighbors_0.01_min_dist")
UMAP_var_logcounts_15_neighbors_0.05_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                                dimred = "UMAP_var_logcounts_15_neighbors_0.05_min_dist",
                                                                colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                                shape_by = "cell.type"#, # "mouse.id"
                                                                #size_by = "detected"
                                                                ) + ggtitle("UMAP_var_logcounts_15_neighbors_0.05_min_dist")
UMAP_var_logcounts_15_neighbors_0.1_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_var_logcounts_15_neighbors_0.1_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_var_logcounts_15_neighbors_0.1_min_dist")
UMAP_var_logcounts_15_neighbors_0.2_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_var_logcounts_15_neighbors_0.2_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_var_logcounts_15_neighbors_0.2_min_dist")

#### n_neighbors = 20
UMAP_var_logcounts_20_neighbors_0.01_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                                dimred = "UMAP_var_logcounts_20_neighbors_0.01_min_dist",
                                                                colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                                shape_by = "cell.type"#, # "mouse.id"
                                                                #size_by = "detected"
                                                                ) + ggtitle("UMAP_var_logcounts_20_neighbors_0.01_min_dist")
UMAP_var_logcounts_20_neighbors_0.05_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                                dimred = "UMAP_var_logcounts_20_neighbors_0.05_min_dist",
                                                                colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                                shape_by = "cell.type"#, # "mouse.id"
                                                                #size_by = "detected"
                                                                ) + ggtitle("UMAP_var_logcounts_20_neighbors_0.05_min_dist")
UMAP_var_logcounts_20_neighbors_0.1_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_var_logcounts_20_neighbors_0.1_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_var_logcounts_20_neighbors_0.1_min_dist")
UMAP_var_logcounts_20_neighbors_0.2_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_var_logcounts_20_neighbors_0.2_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_var_logcounts_20_neighbors_0.2_min_dist")

#### Plot them all:
multiplot(UMAP_var_logcounts_5_neighbors_0.01_min_dist, UMAP_var_logcounts_5_neighbors_0.05_min_dist,
          UMAP_var_logcounts_5_neighbors_0.1_min_dist, UMAP_var_logcounts_5_neighbors_0.2_min_dist,
          cols = 2)
multiplot(UMAP_var_logcounts_10_neighbors_0.01_min_dist, UMAP_var_logcounts_10_neighbors_0.05_min_dist,
          UMAP_var_logcounts_10_neighbors_0.1_min_dist, UMAP_var_logcounts_10_neighbors_0.2_min_dist,
          cols = 2)
multiplot(UMAP_var_logcounts_15_neighbors_0.01_min_dist, UMAP_var_logcounts_15_neighbors_0.05_min_dist,
          UMAP_var_logcounts_15_neighbors_0.1_min_dist, UMAP_var_logcounts_15_neighbors_0.2_min_dist,
          cols = 2)
multiplot(UMAP_var_logcounts_20_neighbors_0.01_min_dist, UMAP_var_logcounts_20_neighbors_0.05_min_dist,
          UMAP_var_logcounts_20_neighbors_0.1_min_dist, UMAP_var_logcounts_20_neighbors_0.2_min_dist,
          cols = 2)
```
...
for(j in range_of_neighbors) {
  for (k in range_of_min_dist) {
    PAG_sceset_qc_norm_filt <- runUMAP(PAG_sceset_qc_norm_filt,
                                       ...
                                       learning_rate = 1,
                                       min_dist = k, # Low values will result in densely packed regions, that will likely more faithfully represent the manifold structure.
                                       name = paste0("UMAP_cv2_logcounts_", j, "_neighbors_", k, "_min_dist"))
  }
}
...
#### n_neighbors = 5
UMAP_cv2_logcounts_5_neighbors_0.01_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_cv2_logcounts_5_neighbors_0.01_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_cv2_logcounts_5_neighbors_0.01_min_dist")
UMAP_cv2_logcounts_5_neighbors_0.05_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_cv2_logcounts_5_neighbors_0.05_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_cv2_logcounts_5_neighbors_0.05_min_dist")
UMAP_cv2_logcounts_5_neighbors_0.1_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                              dimred = "UMAP_cv2_logcounts_5_neighbors_0.1_min_dist",
                                                              colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                              shape_by = "cell.type"#, # "mouse.id"
                                                              #size_by = "detected"
                                                              ) + ggtitle("UMAP_cv2_logcounts_5_neighbors_0.1_min_dist")
UMAP_cv2_logcounts_5_neighbors_0.2_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_cv2_logcounts_5_neighbors_0.2_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_cv2_logcounts_5_neighbors_0.2_min_dist")

#### n_neighbors = 10
UMAP_cv2_logcounts_10_neighbors_0.01_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                                dimred = "UMAP_cv2_logcounts_10_neighbors_0.01_min_dist",
                                                                colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                                shape_by = "cell.type"#, # "mouse.id"
                                                                #size_by = "detected"
                                                                ) + ggtitle("UMAP_cv2_logcounts_10_neighbors_0.01_min_dist")
UMAP_cv2_logcounts_10_neighbors_0.05_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                                dimred = "UMAP_cv2_logcounts_10_neighbors_0.05_min_dist",
                                                                colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                                shape_by = "cell.type"#, # "mouse.id"
                                                                #size_by = "detected"
                                                                ) + ggtitle("UMAP_cv2_logcounts_10_neighbors_0.05_min_dist")
UMAP_cv2_logcounts_10_neighbors_0.1_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_cv2_logcounts_10_neighbors_0.1_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_cv2_logcounts_10_neighbors_0.1_min_dist")
UMAP_cv2_logcounts_10_neighbors_0.2_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_cv2_logcounts_10_neighbors_0.2_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_cv2_logcounts_10_neighbors_0.2_min_dist")

#### n_neighbors = 15
UMAP_cv2_logcounts_15_neighbors_0.01_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                                dimred = "UMAP_cv2_logcounts_15_neighbors_0.01_min_dist",
                                                                colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                                shape_by = "cell.type"#, # "mouse.id"
                                                                #size_by = "detected"
                                                                ) + ggtitle("UMAP_cv2_logcounts_15_neighbors_0.01_min_dist")
UMAP_cv2_logcounts_15_neighbors_0.05_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                                dimred = "UMAP_cv2_logcounts_15_neighbors_0.05_min_dist",
                                                                colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                                shape_by = "cell.type"#, # "mouse.id"
                                                                #size_by = "detected"
                                                                ) + ggtitle("UMAP_cv2_logcounts_15_neighbors_0.05_min_dist")
UMAP_cv2_logcounts_15_neighbors_0.1_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_cv2_logcounts_15_neighbors_0.1_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_cv2_logcounts_15_neighbors_0.1_min_dist")
UMAP_cv2_logcounts_15_neighbors_0.2_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_cv2_logcounts_15_neighbors_0.2_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_cv2_logcounts_15_neighbors_0.2_min_dist")

#### n_neighbors = 20 
UMAP_cv2_logcounts_20_neighbors_0.01_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                                dimred = "UMAP_cv2_logcounts_20_neighbors_0.01_min_dist",
                                                                colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                                shape_by = "cell.type"#, # "mouse.id"
                                                                #size_by = "detected"
                                                                ) + ggtitle("UMAP_cv2_logcounts_20_neighbors_0.01_min_dist")
UMAP_cv2_logcounts_20_neighbors_0.05_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                                dimred = "UMAP_cv2_logcounts_20_neighbors_0.05_min_dist",
                                                                colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                                shape_by = "cell.type"#, # "mouse.id"
                                                                #size_by = "detected"
                                                                ) + ggtitle("UMAP_cv2_logcounts_20_neighbors_0.05_min_dist")
UMAP_cv2_logcounts_20_neighbors_0.1_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_cv2_logcounts_20_neighbors_0.1_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_cv2_logcounts_20_neighbors_0.1_min_dist")
UMAP_cv2_logcounts_20_neighbors_0.2_min_dist <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                                               dimred = "UMAP_cv2_logcounts_20_neighbors_0.2_min_dist",
                                                               colour_by = "PAG.arearegistration", # "batch.processing", "PAG.arearegistration"
                                                               shape_by = "cell.type"#, # "mouse.id"
                                                               #size_by = "detected"
                                                               ) + ggtitle("UMAP_cv2_logcounts_20_neighbors_0.2_min_dist")

#### Plot them all:
multiplot(UMAP_cv2_logcounts_5_neighbors_0.01_min_dist, UMAP_cv2_logcounts_5_neighbors_0.05_min_dist,
          UMAP_cv2_logcounts_5_neighbors_0.1_min_dist, UMAP_cv2_logcounts_5_neighbors_0.2_min_dist,
          cols = 2)
multiplot(UMAP_cv2_logcounts_10_neighbors_0.01_min_dist, UMAP_cv2_logcounts_10_neighbors_0.05_min_dist,
          UMAP_cv2_logcounts_10_neighbors_0.1_min_dist, UMAP_var_logcounts_10_neighbors_0.2_min_dist,
          cols = 2)
multiplot(UMAP_cv2_logcounts_15_neighbors_0.01_min_dist, UMAP_cv2_logcounts_15_neighbors_0.05_min_dist,
          UMAP_cv2_logcounts_15_neighbors_0.1_min_dist, UMAP_cv2_logcounts_10_neighbors_0.2_min_dist,
          cols = 2)
multiplot(UMAP_cv2_logcounts_20_neighbors_0.01_min_dist, UMAP_cv2_logcounts_20_neighbors_0.05_min_dist,
          UMAP_cv2_logcounts_20_neighbors_0.1_min_dist, UMAP_cv2_logcounts_20_neighbors_0.2_min_dist,
          cols = 2)
```
