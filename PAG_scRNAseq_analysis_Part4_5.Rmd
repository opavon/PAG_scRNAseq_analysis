...
# STEP 4A | Modelling technical and biological variability in gene expression to identify highly variable genes
...
```{r}
# With HVGs obtained with variance modeling:
for(n in assayNames(PAG_sceset_qc_norm_filt)) {
    print(
        plotPCA(PAG_sceset_qc_norm_filt,
                rerun = TRUE, 
                colour_by = "PAG.areacollection",
                shape_by = "cell.type",
                size_by = "total_features_by_counts",
                run_args = list(exprs_values = n, feature_set = metadata(PAG_sceset_qc_norm_filt)$hvg_var_out_no_spikes_filt_block[1:1000]) # ntop = 1000
                ) + ggtitle(n) 
...
# With HVGs obtained with CV2 modeling:
for(n in assayNames(PAG_sceset_qc_norm_filt)) {
    print(
        plotPCA(PAG_sceset_qc_norm_filt,
                rerun = TRUE, 
                ...
                shape_by = "cell.type",
                size_by = "total_features_by_counts",
                run_args = list(exprs_values = n, feature_set = metadata(PAG_sceset_qc_norm_filt)$hvg_cv2_out_no_spikes_filt[1:1000]) # ntop = 1000
                ) + ggtitle(n)
...
PAG_sceset_qc_norm_filt_corr <- runPCA(PAG_sceset_qc_norm_filt_corr,
                                       subset_row = metadata(PAG_sceset_qc_norm_filt_corr)$hvg_var_out_no_spikes_block_filt,
                                       name = "PCA_HVG_var")
reducedDimNames(PAG_sceset_qc_norm_filt_corr)
dim(reducedDim(PAG_sceset_qc_norm_filt_corr, "PCA_HVG_var"))

PAG_sceset_qc_norm_filt_corr <- runPCA(PAG_sceset_qc_norm_filt_corr,
                                       subset_row = metadata(PAG_sceset_qc_norm_filt_corr)$hvg_cv2_out_no_spikes_filt,
                                       name = "PCA_HVG_cv2")
reducedDimNames(PAG_sceset_qc_norm_filt_corr)
dim(reducedDim(PAG_sceset_qc_norm_filt_corr, "PCA_HVG_cv2"))
```
...
principal_components <- reducedDim(PAG_sceset_qc_norm_filt_corr, "PCA_HVG_var")
...
```{r}
plotExplanatoryPCs(PAG_sceset_qc_norm_filt_corr,
                   nvars_to_plot = 17,
                   npcs_to_plot = 20,                 
                   variables = c("mouse.id",
                                 "mouse.sex",
...
dim(reducedDim(PAG_sceset_qc_norm_filt_corr, "PCA_denoise")) # Cells are rows, PCs are columns
ncol(reducedDim(PAG_sceset_qc_norm_filt_corr, "PCA_denoise"))
```
...
```{r}
set.seed(1991)
PAG_sceset_qc_norm_filt_corr <- runTSNE(PAG_sceset_qc_norm_filt_corr, dimred="PCA_HVG_var", perplexity=5)
out5 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred="TSNE",
    colour_by="PAGarea_celltype") + ggtitle("perplexity = 5")

set.seed(1991)
PAG_sceset_qc_norm_filt_corr <- runTSNE(PAG_sceset_qc_norm_filt_corr, dimred="PCA_HVG_var", perplexity=20)
out20 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred="TSNE",
    colour_by="PAGarea_celltype") + ggtitle("perplexity = 20")

set.seed(1991)
PAG_sceset_qc_norm_filt_corr <- runTSNE(PAG_sceset_qc_norm_filt_corr, dimred="PCA_HVG_var", perplexity=80)
out80 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred="TSNE", 
    colour_by="PAGarea_celltype") + ggtitle("perplexity = 80")
...
```{r}
set.seed(1991)
PAG_sceset_qc_norm_filt_corr <- runUMAP(PAG_sceset_qc_norm_filt_corr, dimred="PCA_HVG_var")
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred="UMAP", colour_by="PAGarea_celltype")
```
