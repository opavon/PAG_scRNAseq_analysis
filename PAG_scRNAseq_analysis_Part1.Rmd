...
BiocManager::install(c("AnnotationDbi", "BiocNeighbors", "BiocParallel", "beachmat", "clusterExperiment", "DelayedArray", "DESeq2", "destiny", "edgeR", "GenomicRanges", "GenomeInfoDb", "ggfortify", "ggplot2", "httpuv", "iSEE", "limma", "MAST", "matrixStats", "monocle", "MultiAssayExperiment", "mvoutlier", "org.Mm.eg.db", "purrr", "Rhdf5lib", "RUVSeq", "SC3", "scater", "scde", "scfind", "scmap", "SCnorm", "scran", "Seurat", "SingleCellExperiment", "SummarizedExperiment", "sva", "TSCAN", "TxDb.Mmusculus.UCSC.mm10.ensGene", "umap", "uwot"))
```
