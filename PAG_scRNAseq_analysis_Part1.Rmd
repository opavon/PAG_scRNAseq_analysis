...
```{r}
options(stringsAsFactors = FALSE)
PAG_metadata <- data.frame(read.table("PAG_scRNAseq_metadata_211022.csv", 
                                      sep = ",", header = TRUE, row.names = NULL))
...
PAG_metadata$PAGarea_celltype <- factor(paste0(PAG_metadata$PAG.area, "_", PAG_metadata$cell.type),
...
# And one last factor combining cell.type and PAG.PaxinosAPmanual:
