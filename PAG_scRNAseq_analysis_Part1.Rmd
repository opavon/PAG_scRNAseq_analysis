...
# install.packages(c("av", "backports", "boot", "blob", "dbscan", "devtools", "ggplot2", "gganimate", "gifski", "gplots", "HTMLUtils", "hwriter", "igraph", "knitr", "metap", "parallel", "patchwork", "Rcpp" , "rmarkdown", "tidyverse", "uwot"))
