...
BiocManager::install(c("AnnotationDbi", "BiocNeighbors", "BiocParallel", "BiocStyle",  "beachmat", "clusterExperiment", "DelayedArray", "DESeq2", "destiny", "edgeR", "EGSEA", "EGSEAdata", "gage", "GenomicRanges", "GenomeInfoDb", "ggfortify", "globaltest", "GSVA", "httpuv", "iSEE", "knitr", "limma", "MAST", "matrixStats", "monocle", "MultiAssayExperiment", "mvoutlier", "org.Mm.eg.db", "PADOG", "pathview", "pheatmap", "purrr", "Rhdf5lib", "Rtsne", "RUVSeq", "safe", "SC3", "scater", "scde", "scfind", "scmap", "SCnorm", "scran", "Seurat", "SingleCellExperiment", "SummarizedExperiment", "sva", "topGO", "TSCAN", "TxDb.Mmusculus.UCSC.mm10.ensGene", "umap", "uwot", "WGCNA"))
```
...
### One more thing...
Carefully consider the annotations from the metadata that you will need for your biological analysis. Once you know the key ones, add them as `factor`. For example, `PAG.area` or `cell.type` are clearly important, so specifically convert them to factors in the `PAG_metadata` object.
```{r}
