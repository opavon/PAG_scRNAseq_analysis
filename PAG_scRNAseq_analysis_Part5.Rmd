...
PCA_HVG_var_counts <- plotReducedDim(PAG_sceset_qc_norm_filt,
                                     ...
                                     colour_by = "batch.processing", # "batch.processing", "PAG.area", "Cd68"
...
PCA_HVG_var_corrected_celltype_PAGarea <- plotReducedDim(PAG_sceset_qc_norm_filt, 
                                                         ...
                                                         theme_size = 11) + ggtitle("HVG (Var)") + xlab("PC 1") + ylab("PC 2") + theme_args_PCA_composed
PCA_HVG_var_corrected_cd68 <- plotReducedDim(PAG_sceset_qc_norm_filt, 
                                             dimred = "PCA_HVG_var_corrected",
                                             by_exprs_values = "corrected", 
                                             colour_by = "Cd68",
                                             theme_size = 11) + ggtitle("HVG (Var)") + xlab("PC 1") + ylab("PC 2") + theme_args_PCA_composed
...
PCA_HVG_cv2_corrected_cd68 <- plotReducedDim(PAG_sceset_qc_norm_filt, 
                                             dimred = "PCA_HVG_cv2_corrected",
                                             by_exprs_values = "corrected", 
                                             colour_by = "Cd68",
                                             theme_size = 11) + ggtitle("HVG (CV2)") + xlab("PC 1") + ylab("PC 2") + theme_args_PCA_composed
...
PCA_HVG_corrected_composed <- ((PCA_HVG_var_corrected_celltype + PCA_HVG_cv2_corrected_celltype) / 
                                 ...
                                 (PCA_HVG_var_corrected_cd68 + PCA_HVG_cv2_corrected_cd68)) +
...
# Plot the selected t-SNE coloring for Cd68 expression (highly expressed by cells in the monocyte lineage, by circulating macrophages, and by tissue macrophages)
chosen_tSNE_HVG_var_corrected_15_cd68 <- plotReducedDim(PAG_sceset_qc_norm_filt, 
                                                        dimred = "tSNE_var_corrected_perplexity_15",
                                                        colour_by = "Cd68", by_exprs_values = "corrected", shape_by = "cell.type", 
                                                        point_alpha = 0.6, point_size = 2, theme_size = 11
                                                        ) + labs(title = "HVG (Var) - Perplexity = 15", x = "t-SNE 1", y = "t-SNE 2"
                                                                 ) + theme_args_selected_tSNE_UMAP

chosen_tSNE_HVG_cv2_corrected_15_cd68 <- plotReducedDim(PAG_sceset_qc_norm_filt, 
                                                        dimred = "tSNE_cv2_corrected_perplexity_15",
                                                        colour_by = "Cd68", by_exprs_values = "corrected", shape_by = "cell.type", 
                                                        point_alpha = 0.6, point_size = 2, theme_size = 11
                                                        ) + labs(title = "HVG (CV2) - Perplexity = 15", x = "t-SNE 1", y = "t-SNE 2"
...
# Plot the selected UMAP coloring for Cd68 expression (highly expressed by cells in the monocyte lineage, by circulating macrophages, and by tissue macrophages)
chosen_UMAP_var_corrected_15_0.01_cd68 <- plotReducedDim(PAG_sceset_qc_norm_filt, 
                                                         dimred = "UMAP_var_corrected_15_neighbors_0.01_min_dist",
                                                         colour_by = "Cd68", by_exprs_values = "corrected", shape_by = "cell.type", 
                                                         point_alpha = 0.6, point_size = 2, theme_size = 11
                                                         ) + labs(title = "HVG (Var) - 15 neighbors | 0.01 dist", x = "UMAP 1", y = "UMAP 2"
...
chosen_UMAP_cv2_corrected_10_0.01_cd68 <- plotReducedDim(PAG_sceset_qc_norm_filt, 
                                                         dimred = "UMAP_cv2_corrected_10_neighbors_0.01_min_dist",
                                                         colour_by = "Cd68", by_exprs_values = "corrected", shape_by = "cell.type", 
                                                         point_alpha = 0.6, point_size = 2, theme_size = 11
                                                         ) + labs(title = "HVG (CV2) - 10 neighbors | 0.01 dist", x = "UMAP 1", y = "UMAP 2"
...
chosen_UMAP_cv2_corrected_15_0.01_cd68 <- plotReducedDim(PAG_sceset_qc_norm_filt, 
                                                         dimred = "UMAP_cv2_corrected_15_neighbors_0.01_min_dist",
                                                         colour_by = "Cd68", by_exprs_values = "corrected", shape_by = "cell.type", 
                                                         point_alpha = 0.6, point_size = 2, theme_size = 11
                                                         ) + labs(title = "HVG (CV2) - 15 neighbors | 0.01 dist", x = "UMAP 1", y = "UMAP 2"
...
chosen_tSNE_composed <- (chosen_tSNE_HVG_var_corrected_15 + chosen_tSNE_HVG_cv2_corrected_15 +
                           chosen_tSNE_HVG_var_corrected_15_cd68 + chosen_tSNE_HVG_cv2_corrected_15_cd68) +
  plot_annotation(title = "Selected tSNE plots", tag_levels = "A", 
                  theme = theme(plot.title = element_text(size = 12, face = "bold"), plot.tag = element_text(size = 11))) + 
  plot_layout(ncol = 2, guides = "collect")

chosen_UMAP_composed <- ((chosen_UMAP_var_corrected_15_0.01 | chosen_UMAP_var_corrected_15_0.01_cd68) / 
                           (chosen_UMAP_cv2_corrected_10_0.01 | chosen_UMAP_cv2_corrected_10_0.01_cd68) / 
                           (chosen_UMAP_cv2_corrected_15_0.01 | chosen_UMAP_cv2_corrected_15_0.01_cd68)) +
...
* "Cd68", "Cc45" or "Cd14: expressed by cells in the monocyte lineage, by circulating macrophages, and by tissue macrophages (label one of the clusters in our dataset).
