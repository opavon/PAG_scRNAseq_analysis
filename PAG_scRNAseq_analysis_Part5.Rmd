...
explanatory_variables_counts <- plotExplanatoryVariables(PAG_sceset_qc_norm_filt,
                                                         ...
                                                         variables = c("mouse.id", "mouse.sex", "mouse.age", "mouse.singlehousedays",
                                                                       ...
                                                                       "PAG.area", "PAG.hemisphere", "PAG.PaxinosAPmanual", "PAGarea_celltype",
...
PCA_HVG_var_corrected_PAGarea_celltype <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "PCA_HVG_var_corrected",
                                                         by_exprs_values = "corrected", colour_by = "PAGarea_celltype") + ggtitle("HVG (var)")
...
PCA_HVG_cv2_corrected_PAGarea_celltype <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "PCA_HVG_cv2_corrected",
                                                         colour_by = "PAGarea_celltype") + ggtitle("HVG (cv2)")
...
PCA_HVG_corrected_composed <- ((PCA_HVG_var_corrected_celltype + PCA_HVG_cv2_corrected_celltype) / 
                                 ...
                                 (PCA_HVG_var_corrected_PAGarea_celltype + PCA_HVG_cv2_corrected_PAGarea_celltype) / 
