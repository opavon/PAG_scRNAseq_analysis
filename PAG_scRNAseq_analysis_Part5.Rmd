...
subtitle: "Parts V: batch correction and dimensionality reduction"
author:
...
```{r}
plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "PCA_HVG_var_corrected", colour_by = "cell.type", shape_by = "PAG.arearegistration") +
  ggtitle("PCA using HVG (var) and batch corrected")
plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "PCA_HVG_var_corrected", colour_by = "cell.type") +
  ggtitle("PCA using HVG (var) and batch corrected")
plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "PCA_HVG_var_corrected", colour_by = "PAG.arearegistration") +
  ggtitle("PCA using HVG (var) and batch corrected")

plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "PCA_HVG_cv2_corrected", colour_by = "cell.type", shape_by = "PAG.arearegistration") +
  ggtitle("PCA using HVG (cv2) and batch corrected")
plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "PCA_HVG_cv2_corrected", colour_by = "cell.type") +
  ggtitle("PCA using HVG (cv2) and batch corrected")
plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "PCA_HVG_cv2_corrected", colour_by = "PAG.arearegistration") +
  ggtitle("PCA using HVG (cv2) and batch corrected")
```
...
PCA_HVG_var_corrected_PAGarea <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "PCA_HVG_var_corrected",
                                                by_exprs_values = "corrected", colour_by = "PAG.arearegistration") + ggtitle("HVG (var)")
...
PCA_HVG_cv2_corrected_PAGarea <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "PCA_HVG_cv2_corrected",
                                                colour_by = "PAG.arearegistration") + ggtitle("HVG (cv2)")
...
tSNE_HVG_var_corrected_5 <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "tSNE_var_corrected_perplexity_5",
                                           colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "Perplexity = 5", x = "t-SNE 1", y = "t-SNE 2")

tSNE_HVG_var_corrected_10 <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "tSNE_var_corrected_perplexity_10",
                                            colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "Perplexity = 10", x = "t-SNE 1", y = "t-SNE 2")

tSNE_HVG_var_corrected_15 <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "tSNE_var_corrected_perplexity_15",
                                            colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "Perplexity = 15", x = "t-SNE 1", y = "t-SNE 2")

tSNE_HVG_var_corrected_20 <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "tSNE_var_corrected_perplexity_20",
                                            colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "Perplexity = 20", x = "t-SNE 1", y = "t-SNE 2")

tSNE_HVG_var_corrected_30 <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "tSNE_var_corrected_perplexity_30",
                                            colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "Perplexity = 30", x = "t-SNE 1", y = "t-SNE 2")

tSNE_HVG_var_corrected_40 <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "tSNE_var_corrected_perplexity_40",
                                            colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "Perplexity = 40", x = "t-SNE 1", y = "t-SNE 2")

tSNE_HVG_var_corrected_50 <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "tSNE_var_corrected_perplexity_50",
                                            colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "Perplexity = 50", x = "t-SNE 1", y = "t-SNE 2")
  
tSNE_HVG_var_corrected_75 <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "tSNE_var_corrected_perplexity_75",
                                            colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "Perplexity = 75", x = "t-SNE 1", y = "t-SNE 2")
...
chosen_tSNE_HVG_var_corrected_15 <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "tSNE_var_corrected_perplexity_15",
                                                   colour_by = "PAG.arearegistration", shape_by = "cell.type", point_alpha = 0.6, point_size = 2
...
chosen_UMAP_cv2_facet_celltype <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
                                                 colour_by = "PAG.arearegistration", point_alpha = 0.6, point_size = 2
...
chosen_UMAP_cv2_facet_PAGarea <- plotReducedDim(PAG_sceset_qc_norm_filt, dimred = "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
                                                colour_by = "cell.type", point_alpha = 0.6, point_size = 2
                                                         ...
                                                         ) + facet_wrap(~PAG_sceset_qc_norm_filt$PAG.arearegistration, dir = "v")
