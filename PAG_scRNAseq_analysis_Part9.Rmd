...
for(n in range_of_perplexities) {
    print(
        plotTSNE(
            ...
            rerun = TRUE, 
            ncomponents = 2, 
            colour_by = "PAG.areacollection", # "batch.processing"
            shape_by = "cell.type",
            size_by = "total_features_by_counts",
...
tsne_p20 <- plotTSNE(PAG_sceset_qc_norm_filt_corr,
                     ...
                     colour_by = "PAG.areacollection") + fontsize + ggtitle("Perplexity = 20")
...
plotUMAP(PAG_sceset_qc_norm_filt_corr,
         ...
         ncomponents = 2,
         run_args = list(feature_set = metadata(PAG_sceset_qc_norm_filt_corr)$hvg_out_no_spikes_filt[1:1000], exprs_values = "corrected"),
         colour_by = "PAG.areacollection", # You can also choose a specific gene (e.g. "Gad1") or shape_by = "cell.type"
         shape_by="cell.type")
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_ionchannels[1:15],
            exprs_values = "logcounts", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_ionchannels[1:15], 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_ionchannels[1:15], 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_ionchannels[1:15],
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_ionchannels[1:15], 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_ionchannels[1:15],
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_potassium,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_potassium, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_potassium, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_potassium,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_potassium, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_potassium,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_calcium,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_calcium, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_calcium, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_calcium,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_calcium, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_calcium,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_sodium,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_sodium, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_sodium, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_sodium,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_sodium, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_sodium,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps by cell type
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_chloride,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_chloride, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_chloride, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_chloride,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_chloride, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_chloride,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps by cell type
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_asic,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_asic, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_asic, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_asic,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_asic, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_asic,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps by cell type
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_cyclic_nucleotides,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_cyclic_nucleotides, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_cyclic_nucleotides, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_cyclic_nucleotides,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_cyclic_nucleotides, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_cyclic_nucleotides,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps by cell type
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_trp,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_trp, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_trp, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_trp,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_trp, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_trp,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps by cell type
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_connexins,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_connexins, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_connexins, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_connexins,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_connexins, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_connexins,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps by cell type
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_purinergic,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_purinergic, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_purinergic, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_purinergic,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_purinergic, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_purinergic,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps by cell type
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_aquaporins,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_aquaporins, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_aquaporins, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_aquaporins,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_aquaporins, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_aquaporins,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps by cell type
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_otherchannels,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_otherchannels, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_otherchannels, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_otherchannels,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_otherchannels, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_otherchannels,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_gaba,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_gaba, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_gaba, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_gaba,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_gaba, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_gaba,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_glutamate,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_glutamate, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_glutamate, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_glutamate,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_glutamate, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_glutamate,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_acetylcholine,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_acetylcholine, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_acetylcholine, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_acetylcholine,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_acetylcholine, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_acetylcholine,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_monoamines,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_monoamines, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_monoamines, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_monoamines,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_monoamines, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_monoamines,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_transporters,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_transporters, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_transporters, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_transporters,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_transporters, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_transporters,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
```{r}
# Get the ion channel gene names from the appropriate column and filter any genes not present in our dataset:
PAG_Neuromodulators_Peptides <- metadata(PAG_sceset_qc_norm_filt_corr)$genes.NeuromodulatorsPeptides[(metadata(PAG_sceset_qc_norm_filt_corr)$genes.NeuromodulatorsPeptides %in% rownames(PAG_sceset_qc_norm_filt_corr))]
length(PAG_Neuromodulators_Peptides)

# Make violing plots
plotExpression(PAG_sceset_qc_norm_filt_corr, PAG_Neuromodulators_Peptides,  
               x = "cell.type", colour_by = "cell.type",
               exprs_values = "logcounts", ncol = 10, show_median = TRUE,
               xlab ="Cell Type")
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_Neuromodulators_Peptides,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_Neuromodulators_Peptides, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_Neuromodulators_Peptides, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_Neuromodulators_Peptides,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_Neuromodulators_Peptides, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_Neuromodulators_Peptides,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_celltypes,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_celltypes, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_celltypes, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_celltypes,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_celltypes, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_celltypes,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_DEgenesQMUL,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_DEgenesQMUL, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_DEgenesQMUL, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_DEgenesQMUL,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_DEgenesQMUL, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_DEgenesQMUL,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_DEgenesMB,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_DEgenesMB, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_DEgenesMB, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_DEgenesMB,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_DEgenesMB, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_DEgenesMB,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
```{r}
# Get the ion channel gene names from the appropriate column and filter any genes not present in our dataset:
PAG_Dulac_neuromodulators <- metadata(PAG_sceset_qc_norm_filt_corr)$genes.DulacNeuromodulators[(metadata(PAG_sceset_qc_norm_filt_corr)$genes.DulacNeuromodulators %in% rownames(PAG_sceset_qc_norm_filt_corr))]
length(PAG_Dulac_neuromodulators)

# Make violing plots
plotExpression(PAG_sceset_qc_norm_filt_corr, PAG_Dulac_neuromodulators,  
               x = "cell.type", colour_by = "cell.type",
               exprs_values = "logcounts", ncol = 10, show_median = TRUE,
               xlab ="Cell Type")
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_Dulac_neuromodulators,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_Dulac_neuromodulators, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_Dulac_neuromodulators, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_Dulac_neuromodulators,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_Dulac_neuromodulators, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_Dulac_neuromodulators,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
```{r}
# Get the ion channel gene names from the appropriate column and filter any genes not present in our dataset:
PAG_Dulac_neuropeptides <- metadata(PAG_sceset_qc_norm_filt_corr)$genes.DulacNeuropeptides[(metadata(PAG_sceset_qc_norm_filt_corr)$genes.DulacNeuropeptides %in% rownames(PAG_sceset_qc_norm_filt_corr))]
length(PAG_Dulac_neuropeptides)

# Make violing plots
plotExpression(PAG_sceset_qc_norm_filt_corr, PAG_Dulac_neuropeptides,  
               x = "cell.type", colour_by = "cell.type",
               exprs_values = "logcounts", ncol = 10, show_median = TRUE,
               xlab ="Cell Type")
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_Dulac_neuropeptides,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_Dulac_neuropeptides, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_Dulac_neuropeptides, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_Dulac_neuropeptides,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_Dulac_neuropeptides, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_Dulac_neuropeptides,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
```{r}
# Get the ion channel gene names from the appropriate column and filter any genes not present in our dataset:
PAG_Dulac_TFs <- metadata(PAG_sceset_qc_norm_filt_corr)$genes.DulacTranscriptionfactors[(metadata(PAG_sceset_qc_norm_filt_corr)$genes.DulacTranscriptionfactors %in% rownames(PAG_sceset_qc_norm_filt_corr))]
length(PAG_Dulac_TFs)

# Make violing plots
plotExpression(PAG_sceset_qc_norm_filt_corr, PAG_Dulac_TFs,  
               x = "cell.type", colour_by = "cell.type",
               exprs_values = "logcounts", ncol = 10, show_median = TRUE,
               xlab ="Cell Type")
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_Dulac_TFs,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_Dulac_TFs, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_Dulac_TFs, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_Dulac_TFs,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_Dulac_TFs, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_Dulac_TFs,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_Dan,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_Dan, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_Dan, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_Dan,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_Dan, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_Dan,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_Gross,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_Gross, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_Gross, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_Gross,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_Gross, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_Gross,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_Dario,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_Dario, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], PAG_Dario, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], PAG_Dario,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], PAG_Dario, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], PAG_Dario,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps by cell type
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], DataClub_ionchannels,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], DataClub_ionchannels, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], DataClub_ionchannels, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], DataClub_ionchannels,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], DataClub_ionchannels, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], DataClub_ionchannels,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps by cell type
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], DataClub_neuromodulators,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], DataClub_neuromodulators, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], DataClub_neuromodulators, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], DataClub_neuromodulators,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], DataClub_neuromodulators, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], DataClub_neuromodulators,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
# Make Heatmaps by cell type
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], DataClub_neuropeptides,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#ff777c"))(100), border_color = NA, 
            colour_columns_by = "PAG.areacollection", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], DataClub_neuropeptides, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#009CB5"))(100), border_color = NA,
            colour_columns_by = "PAG.areacollection", 
...
# Make Heatmaps by PAG subdivision
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dmpag"], DataClub_neuropeptides, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#F6C324"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="dlpag"], DataClub_neuropeptides,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#E3AE09"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="lpag"], DataClub_neuropeptides, 
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#B78C08"))(100), border_color = NA,
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag"], DataClub_neuropeptides,
            exprs_values = "logcounts", 
            center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
            color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
            colour_columns_by = "cell.type", 
...
plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection=="vlpag" & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], DataClub_neuropeptides,
                 exprs_values = "logcounts", 
                 center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, #zlim = c(0,10), 
                 color = colorRampPalette(c("white", "#8B6A06"))(100), border_color = NA, 
                 #colour_columns_by = "cell.type", 
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], DataClub_neuropeptides,
                      ...
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      show_colnames = FALSE,             
                      main = paste("Expression of Neuropeptides in", celltype, "cells"))
  print(plot)
  }

for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.areacollection)[2:5]){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], DataClub_neuropeptides,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,10),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      show_colnames = FALSE,             
                      main = paste("Expression of Neuropeptides in", area, "VGAT cells"))
  print(plot)
  }

for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.areacollection)[2:5]){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.areacollection==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], DataClub_neuropeptides,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,10),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      show_colnames = FALSE,             
                      main = paste("Expression of Neuropeptides in", area, "VGluT2 cells"))
  print(plot)
  }
```
