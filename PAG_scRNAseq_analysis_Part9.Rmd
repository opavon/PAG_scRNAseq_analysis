...
## Step 9.1 | Pre-processing, data QC and normalization
...
## Step 9.2 | Feature selection: identify highly variable features
...
## Step 9.3 | Scaling the data, peforming dimensionality reduction and determining the dimensionality of the dataset
...
## Step 9.5 | Non-linear dimensionality reduction (UMAP and t-SNE)
...
## Step 9.6 | Finding differentially expressed features (cluster biomarkers)
...
## Step 9.7 | Assigning cell type identity to clusters
