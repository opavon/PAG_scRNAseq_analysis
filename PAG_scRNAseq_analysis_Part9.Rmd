...
for(n in range_of_perplexities) {
    print(
        plotTSNE(
            ...
            rerun = TRUE, 
            ncomponents = 2, 
            colour_by = "PAG.arearegistration", # "batch.processing"
            shape_by = "cell.type",
            size_by = "total_features_by_counts",
...
tsne_p20 <- plotTSNE(PAG_sceset_qc_norm_filt_corr,
                     ...
                     colour_by = "PAG.arearegistration") + fontsize + ggtitle("Perplexity = 20")
...
plotUMAP(PAG_sceset_qc_norm_filt_corr,
         ...
         ncomponents = 2,
         run_args = list(feature_set = metadata(PAG_sceset_qc_norm_filt_corr)$hvg_out_no_spikes_filt[1:1000], exprs_values = "corrected"),
         colour_by = "PAG.arearegistration", # You can also choose a specific gene (e.g. "Gad1") or shape_by = "cell.type"
         shape_by="cell.type")
...
* Alternate between `x = "PAG.arearegistration", colour_by = "cell.type"` or `x = "cell.type", colour_by = "PAG.arearegistration"`
...
plotExpression(PAG_sceset_qc_norm_filt_corr, PAG_ionchannels[1:20],  
               x = "PAG.arearegistration", colour_by = "cell.type",
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_ionchannels,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/IonChannels_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }

# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_ionchannels,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/IonChannels_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_ionchannels,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/IonChannels_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_potassium,
                      ...
                      width = 10, height = 15,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Potassium/Potassium_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_potassium,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 10, height = 15,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Potassium/Potassium_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_potassium,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 10, height = 15,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Potassium/Potassium_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_calcium,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Calcium/Calcium_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_calcium,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Calcium/Calcium_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_calcium,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Calcium/Calcium_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_sodium,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Sodium/Sodium_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_sodium,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Sodium/Sodium_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_sodium,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Sodium/Sodium_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_chloride,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Chloride/Chloride_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_chloride,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Chloride/Chloride_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_chloride,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Chloride/Chloride_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_asic,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Asic/ASIC_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_asic,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Asic/ASIC_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_asic,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Asic/ASIC_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_cyclic_nucleotides,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Cyclic/CyclicNucleotides_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_cyclic_nucleotides,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Cyclic/CyclicNucleotides_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_cyclic_nucleotides,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Cyclic/CyclicNucleotides_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_trp,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/TRP/TRP_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_trp,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/TRP/TRP_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_trp,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/TRP/TRP_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_connexins,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Connexins/Connexins_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_connexins,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Connexins/Connexins_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_connexins,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Connexins/Connexins_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_purinergic,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Purinergic/PurinergicICs_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_purinergic,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Purinergic/PurinergicICs_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_purinergic,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Purinergic/PurinergicICs_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_aquaporins,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Aquaporins/Aquaporins_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_aquaporins,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Aquaporins/Aquaporins_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_aquaporins,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Aquaporins/Aquaporins_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_otherchannels,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/OtherIC/OtherIC_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_otherchannels,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/OtherIC/OtherIC_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_otherchannels,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/OtherIC/OtherIC_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_gaba,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/GABA/GABA_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_gaba,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/GABA/GABA_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_gaba,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/GABA/GABA_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_glutamate,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Glutamate/Glutamate_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_glutamate,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Glutamate/Glutamate_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_glutamate,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Glutamate/Glutamate_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_acetylcholine,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Acetylcholine/Acetylcholine_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_acetylcholine,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Acetylcholine/Acetylcholine_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_acetylcholine,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Acetylcholine/Acetylcholine_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_transporters,
                      ...
                      width = 40, height = 50,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Transporters/Transporters_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_transporters,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 40, height = 50,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Transporters/Transporters_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_transporters,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 40, height = 50,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Transporters/Transporters_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_monoamines,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Monoamines/Monoamines_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_monoamines,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Monoamines/Monoamines_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_monoamines,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Monoamines/Monoamines_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_neuromodulators,
                      ...
                      width = 13, height = 20,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Neuromodulators/Neuromodulators_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_neuromodulators,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 13, height = 20,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Neuromodulators/Neuromodulators_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_neuromodulators,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 13, height = 20,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Neuromodulators/Neuromodulators_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_neuropeptides,
                      ...
                      width = 10, height = 15,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Neuropeptides/Neuropeptides_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_neuropeptides,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 10, height = 15,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Neuropeptides/Neuropeptides_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_neuropeptides,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 10, height = 15,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/Neuropeptides/Neuropeptides_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```

## STEP X.3 | DE genes from DESeq2 analysis
```{r}
# Get the ion channel gene names from the appropriate column and filter any genes not present in our dataset:
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_DEseq2_genes,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/DESeq2_genes/DESeq2_genes_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_DEseq2_genes,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/DESeq2_genes/DESeq2_genes_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_DEseq2_genes,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/DESeq2_genes/DESeq2_genes_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```

## Step X.5 | Gene Lists from Literature and Labs
### Cell type markers
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_celltypes,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/CellTypeMarkers/CellTypeGenes_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_celltypes,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/CellTypeMarkers/CellTypeGenes_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_celltypes,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/CellTypeMarkers/CellTypeGenes_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_interneurons,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/InterneuronMarkers/InterneuronMarkers_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_interneurons,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/InterneuronMarkers/InterneuronMarkers_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_interneurons,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/InterneuronMarkers/InterneuronMarkers_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_DEgenesQMUL,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/QMUL_DE/QMUL_DE_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_DEgenesQMUL,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/QMUL_DE/QMUL_DE_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_DEgenesQMUL,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/QMUL_DE/QMUL_DE_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_DEgenesMB,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/MB_DE_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_DEgenesMB,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/MB_DE_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_DEgenesMB,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/MB_DE_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```

### Yang Dan's Sleep Genes
```{r}
# Get the ion channel gene names from the appropriate column and filter any genes not present in our dataset:
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_Dan,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/DanLabGenes/DanLabGenes_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_Dan,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/DanLabGenes/DanLabGenes_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_Dan,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/DanLabGenes/DanLabGenes_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_Gross,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/GrossLabGenes/GrossLabGenes_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_Gross,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/GrossLabGenes/GrossLabGenes_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_Gross,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/GrossLabGenes/GrossLabGenes_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], PAG_Dario,
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/DariosGenes/DariosGenes_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], PAG_Dario,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/DariosGenes/DariosGenes_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], PAG_Dario,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/DariosGenes/DariosGenes_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```

## Step X.6 | Data Club plots
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], DataClub_ionchannels,
                      ...
                      main = paste("Ion Channels in", celltype, "cells"), 
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/ICDataClub/ICDataClub_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], DataClub_ionchannels,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      main = paste("Ion Channels in", area, "VGAT cells"), 
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/ICDataClub/ICDataClub_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], DataClub_ionchannels,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      main = paste("Ion Channels in", area, "VGluT2 cells"), 
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/ICDataClub/ICDataClub_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], DataClub_neuromodulators,
                      ...
                      main = paste("Neuromodulators in", celltype, "cells"), 
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/nmDataClub/nmDataClub_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], DataClub_neuromodulators,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      main = paste("Neuromodulators in", area, "VGAT cells"), 
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/nmDataClub/nmDataClub_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], DataClub_neuromodulators,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      main = paste("Neuromodulators in", area, "VGluT2 cells"), 
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/nmDataClub/nmDataClub_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```
...
for(celltype in levels(PAG_sceset_qc_norm_filt_corr$cell.type)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$cell.type==celltype], DataClub_neuropeptides,
                      ...
                      main = paste("Neuropeptides in", celltype, "cells"), 
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/npDataClub/npDataClub_", celltype, "_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGAT cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGAT"], DataClub_neuropeptides,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGAT, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      main = paste("Neuropeptides in", area, "VGAT cells"), 
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/npDataClub/npDataClub_", area, "_VGAT_cells.png", sep = "")
                      )
  print(plot)
  }
...
# Make Heatmaps by PAG subdivision (VGluT2 cells)
for(area in levels(PAG_sceset_qc_norm_filt_corr$PAG.arearegistration)){
  plot <- plotHeatmap(PAG_sceset_qc_norm_filt_corr[, PAG_sceset_qc_norm_filt_corr$PAG.arearegistration==area & PAG_sceset_qc_norm_filt_corr$cell.type=="VGluT2"], DataClub_neuropeptides,
                      exprs_values = "logcounts", 
                      center = FALSE, cluster_rows = FALSE, cluster_cols = FALSE, zlim = c(0,12),
                      color = heatcolor_VGluT2, border_color = NA,              
                      fontsize = 12,# cellwidth = 2, cellheight = 3, 
                      ...
                      main = paste("Neuropeptides in", area, "VGluT2 cells"), 
                      width = 6, height = 8,
                      filename = paste("D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Heatmaps/npDataClub/npDataClub_", area, "_VGluT2_cells.png", sep = "")
                      )
  print(plot)
  }
```