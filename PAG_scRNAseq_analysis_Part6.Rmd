...
# STEP 6 | Clustering
We have now normalized the data, identified highly variable genes, corrected confounding factors, and applied dimentionality reduction techniques to better visualize and summarize our data. We can now proceed to carry out analyses that are relevant to the biological questions at hand.
...
```{r}
## Using t-SNE (var)
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_var_corrected_perplexity_15",
               colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "tSNE_var_corrected_perplexity_15", x = "t-SNE 1", y = "t-SNE 2")

# Using HVG from Var with rank-based weights
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_var_corrected_perplexity_15",
               colour_by = "SNN_clusters_var_rank", shape_by = "cell.type", 
               text_by = "SNN_clusters_var_rank") + labs(title = "tSNE_var_corrected_perplexity_15", x = "t-SNE 1", y = "t-SNE 2")

# Using HVG from Var with jaccard-based weights
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_var_corrected_perplexity_15",
               colour_by = "SNN_clusters_var_jaccard", shape_by = "cell.type", 
               text_by = "SNN_clusters_var_jaccard") + labs(title = "tSNE_var_corrected_perplexity_15", x = "t-SNE 1", y = "t-SNE 2")

## Using t-SNE (cv2)
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_cv2_corrected_perplexity_15",
               colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "tSNE_cv2_corrected_perplexity_15", x = "t-SNE 1", y = "t-SNE 2")

# Using HVG from CV2 with rank-based weights
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_cv2_corrected_perplexity_15",
               colour_by = "SNN_clusters_cv2_rank", shape_by = "cell.type", 
               text_by = "SNN_clusters_cv2_rank") + labs(title = "tSNE_cv2_corrected_perplexity_15", x = "t-SNE 1", y = "t-SNE 2")

# Using HVG from CV2 with jaccard-based weights
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_cv2_corrected_perplexity_15",
               colour_by = "SNN_clusters_cv2_jaccard", shape_by = "cell.type", 
               text_by = "SNN_clusters_cv2_jaccard") + labs(title = "tSNE_cv2_corrected_perplexity_15", x = "t-SNE 1", y = "t-SNE 2")


## Using UMAP (var)
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_var_corrected_10_neighbors_0.01_min_dist", 
               colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "UMAP_var_corrected_10_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")

# Using HVG from Var with rank-based weights
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_var_corrected_10_neighbors_0.01_min_dist",
               colour_by = "SNN_clusters_var_rank", shape_by = "cell.type", 
               text_by = "SNN_clusters_var_rank") + labs(title = "UMAP_var_corrected_10_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")

# Using HVG from Var with jaccard-based weights
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_var_corrected_10_neighbors_0.01_min_dist",
               colour_by = "SNN_clusters_var_jaccard", shape_by = "cell.type", 
               text_by = "SNN_clusters_var_jaccard") + labs(title = "UMAP_var_corrected_10_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")
...
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_cv2_corrected_15_neighbors_0.01_min_dist",
               colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "UMAP_cv2_corrected_15_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")

# Using HVG from CV2 with rank-based weights
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_cv2_corrected_15_neighbors_0.01_min_dist",
               colour_by = "SNN_clusters_cv2_rank", shape_by = "cell.type", 
               text_by = "SNN_clusters_cv2_rank") + labs(title = "UMAP_cv2_corrected_15_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")

# Using HVG from CV2 with jaccard-based weights
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_cv2_corrected_15_neighbors_0.01_min_dist",
               colour_by = "SNN_clusters_cv2_jaccard", shape_by = "cell.type", 
               text_by = "SNN_clusters_cv2_jaccard") + labs(title = "UMAP_cv2_corrected_15_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")
```

`k` = 9 or 10 achieves the best results and corresponds pretty well with the tSNE and UMAP plots. It seems that jaccard based weights work better in our dataset, and that again using the PCA loadings from CV2 modelling achieves the best result.
...
originals <- myClusterFUN(PAG_sceset_qc_norm_filt_corr)

set.seed(1714)
coassign <- bootstrapCluster(PAG_sceset_qc_norm_filt_corr, 
                             FUN = myClusterFUN, 
                             clusters = originals)
dim(coassign)
```

The function returns a matrix of coassignment probabilities between every pair of original clusters in `originals`. Each coassignment probability between clusters X and Y represents the probability that a randomly chosen cell from X and a randomly chosen from Y are assigned to the same cluster in the bootstrap replicate. High co-assignment probabilities indicate that X is not stable with respect to its separation from Y, given that their cells are liable to cluster together in the replicates. Ideally, we would hope for high coassignment probabilites on the diagonal (i.e., X cells cluster with themselves) and low probabilites off the diagonal.
```{r}
...
## Step 6.1b | Cell-type specific Graph-based clustering
...
## Step 6.2 | Consensus clustering with SC3
...
### 6.2.1 | Prepare SingleCellExperiment object for SC3
...
### 6.2.3 | Calculate distances and transformations
...
### 6.2.7 | Running SC3 with the wrapper function [OPTIONAL ALTERNATIVE]
...
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_var_corrected_perplexity_15",
               colour_by = "cluster_kmeans_var", shape_by = "cell.type", 
               text_by = "cluster_kmeans_var") + labs(title = "tSNE_var_corrected_perplexity_15", x = "t-SNE 1", y = "t-SNE 2")
...
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_cv2_corrected_perplexity_15",
               colour_by = "cluster_kmeans_cv2", shape_by = "cell.type", 
               text_by = "cluster_kmeans_cv2") + labs(title = "tSNE_cv2_corrected_perplexity_15", x = "t-SNE 1", y = "t-SNE 2")

# UMAP using PCA from HVG_var_logcounts
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_var_corrected_10_neighbors_0.01_min_dist",
               colour_by = "PAG.arearegistration", shape_by = "cell.type")  + labs(title = "UMAP_var_corrected_10_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")

plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_var_corrected_10_neighbors_0.01_min_dist", 
               colour_by = "cluster_kmeans_var", shape_by = "cell.type",
               text_by = "cluster_kmeans_var") + labs(title = "UMAP_var_corrected_10_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")

# UMAP using PCA from HVG_cv2_logcounts
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_cv2_corrected_15_neighbors_0.01_min_dist",
               colour_by = "PAG.arearegistration", shape_by = "cell.type")  + labs(title = "UMAP_cv2_corrected_15_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")

plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_cv2_corrected_15_neighbors_0.01_min_dist", 
               colour_by = "cluster_kmeans_cv2", shape_by = "cell.type",
               text_by = "cluster_kmeans_cv2")  + labs(title = "UMAP_cv2_corrected_15_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")
```
...
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_var_corrected_perplexity_15",
               colour_by = "overcluster_kmeans_var", shape_by = "cell.type", 
               text_by = "overcluster_kmeans_var") + labs(title = "tSNE_var_corrected_perplexity_15", x = "t-SNE 1", y = "t-SNE 2")
...
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_cv2_corrected_perplexity_15",
               colour_by = "overcluster_kmeans_cv2", shape_by = "cell.type", 
               text_by = "overcluster_kmeans_cv2") + labs(title = "tSNE_cv2_corrected_perplexity_15", x = "t-SNE 1", y = "t-SNE 2")
...
plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_var_corrected_10_neighbors_0.01_min_dist", 
               colour_by = "overcluster_kmeans_var", shape_by = "cell.type",
               text_by = "overcluster_kmeans_var") + labs(title = "UMAP_var_corrected_10_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")
...
plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_cv2_corrected_15_neighbors_0.01_min_dist", 
               colour_by = "overcluster_kmeans_cv2", shape_by = "cell.type",
               text_by = "overcluster_kmeans_cv2")  + labs(title = "UMAP_cv2_corrected_15_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")
```
...
```{r}
# Clustering with the estimated k
...
plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_var_corrected_10_neighbors_0.01_min_dist", 
               colour_by = "clusters_var_cutree", text_by = "clusters_var_cutree") + labs(title = "UMAP_var_corrected_10_neighbors_0.01_min_dist", x = "UMAP 1", y = "UMAP 2")

# Using PCA from HVG_cv2_logcounts
plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
               colour_by = "PAG.arearegistration", shape_by = "cell.type")  + labs(title = "UMAP_cv2_corrected_10_neighbors_0.05_min_dist", x = "UMAP 1", y = "UMAP 2")

PAG_sceset_qc_norm_filt_corr$clusters_cv2_cutree <- factor(PAG_clust_cv2_cutree)
plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_cv2_corrected_10_neighbors_0.05_min_dist", 
               colour_by = "clusters_cv2_cutree", text_by = "clusters_cv2_cutree")  + labs(title = "UMAP_cv2_corrected_10_neighbors_0.05_min_dist", x = "UMAP 1", y = "UMAP 2")
```
