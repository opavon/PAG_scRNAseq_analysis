...
combined_fac_var <- paste0(PAG_sceset_qc_norm_filt_corr$celltype_PAGarea)
labels_colors(PAG_dend_var) <- colours_celltype_PAGarea[combined_fac_var][order.dendrogram(PAG_dend_var)]
...
combined_fac_cv2 <- paste0(PAG_sceset_qc_norm_filt_corr$celltype_PAGarea)
labels_colors(PAG_dend_cv2) <- colours_celltype_PAGarea[combined_fac_cv2][order.dendrogram(PAG_dend_cv2)]
...
pdf(file = str_c(path_for_figures, date, "_hierarchical_dendrogram_cv2.pdf"),
    width = 12, height = 9,
    family = "Helvetica", bg = "transparent")
labels_colors(PAG_dend_cv2) <- colours_celltype_PAGarea[combined_fac_var][order.dendrogram(PAG_dend_cv2)]
plot(PAG_dend_cv2, main = "Dendrogram from hierarchical clustering (cv2)", ylab = "Height", las = 1)
legend("topright", col = colours_celltype_PAGarea, pch = 19, cex = 0.75,  bty = "n",
       legend = levels(PAG_sceset_qc_norm_filt_corr$celltype_PAGarea))
dev.off()
