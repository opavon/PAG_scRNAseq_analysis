...
tSNE_var_PAGsubdivisions <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_var_corrected_perplexity_15",
                                           colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "t-SNE (var) - PAG subdivisions",
                                                                                                              x = "t-SNE 1", y = "t-SNE 2")

# Using HVG from Var with rank-based weights
tSNE_var_RankWalktrap_k8 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_var_corrected_perplexity_15",
                                           colour_by = "SNN_clusters_var_rank_k8", shape_by = "cell.type", 
                                           text_by = "SNN_clusters_var_rank_k8") + labs(title = "t-SNE (var) - Rank-Walktrap (k=8)", x = "t-SNE 1", y = "t-SNE 2")

# Using HVG from Var with jaccard-based weights
tSNE_var_JaccardLouvain_k10 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_var_corrected_perplexity_15",
                                              colour_by = "SNN_clusters_var_jaccard_k10", shape_by = "cell.type", 
                                              text_by = "SNN_clusters_var_jaccard_k10") + labs(title = "t-SNE (var) - Jaccard-Louvain (k=10)", x = "t-SNE 1", y = "t-SNE 2")

## Using t-SNE (cv2)
tSNE_cv2_PAGsubdivisions <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_cv2_corrected_perplexity_15",
                                           colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "t-SNE (cv2) - PAG subdivisions",
                                                                                                              x = "t-SNE 1", y = "t-SNE 2")

# Using HVG from CV2 with rank-based weights
tSNE_cv2_RankWalktrap_k7 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_cv2_corrected_perplexity_15",
                                           colour_by = "SNN_clusters_cv2_rank_k7", shape_by = "cell.type", 
                                           text_by = "SNN_clusters_cv2_rank_k7") + labs(title = "t-SNE (cv2) - Rank-Walktrap (k=7)", x = "t-SNE 1", y = "t-SNE 2")

# Using HVG from CV2 with jaccard-based weights
tSNE_cv2_JaccardLouvain_k8 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_cv2_corrected_perplexity_15",
                                             colour_by = "SNN_clusters_cv2_jaccard_k8", shape_by = "cell.type", 
                                             text_by = "SNN_clusters_cv2_jaccard_k8") + labs(title = "t-SNE (cv2) - Jaccard-Louvain (k=8)", x = "t-SNE 1", y = "t-SNE 2")
tSNE_cv2_JaccardLouvain_k10 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_cv2_corrected_perplexity_15",
                                              ...
                                              text_by = "SNN_clusters_cv2_jaccard_k10") + labs(title = "t-SNE (cv2) - Jaccard-Louvain (k=10)", x = "t-SNE 1", y = "t-SNE 2")
...
UMAP_var_PAGsubdivisions <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_var_corrected_10_neighbors_0.01_min_dist",
                                           colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "UMAP (var) - PAG subdivisions",
                                                                                                              x = "UMAP 1", y = "UMAP 2")
...
UMAP_var_RankWalktrap_k8 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_var_corrected_10_neighbors_0.01_min_dist",
                                           colour_by = "SNN_clusters_var_rank_k8", shape_by = "cell.type", 
                                           text_by = "SNN_clusters_var_rank_k8") + labs(title = "UMAP (var) - Rank-Walktrap (k=8)", x = "UMAP 1", y = "UMAP 2")
...
UMAP_var_JaccardLouvain_k10 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_var_corrected_10_neighbors_0.01_min_dist",
                                              colour_by = "SNN_clusters_var_jaccard_k10", shape_by = "cell.type", 
                                              text_by = "SNN_clusters_var_jaccard_k10") + labs(title = "UMAP (var) - Jaccard-Louvain (k=10)", x = "UMAP 1", y = "UMAP 2")
...
UMAP_cv2_10_005_PAGsubdivisions <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
                                                  colour_by = "PAG.arearegistration", shape_by = "cell.type") + labs(title = "UMAP (cv2) - PAG subdivisions", 
                                                                                                                     x = "UMAP 1", y = "UMAP 2")
...
UMAP_cv2_10_005_RankWalktrap_k7 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
                                                  colour_by = "SNN_clusters_cv2_rank_k7", shape_by = "cell.type", 
                                                  text_by = "SNN_clusters_cv2_rank_k7") + labs(title = "UMAP (cv2) - Rank-Walktrap (k=7)", x = "UMAP 1", y = "UMAP 2")
...
UMAP_cv2_10_005_JaccardLouvain_k8 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
                                                    colour_by = "SNN_clusters_cv2_jaccard_k8", shape_by = "cell.type", 
                                                    text_by = "SNN_clusters_cv2_jaccard_k8") + labs(title = "UMAP (cv2) - Jaccard-Louvain (k=8)", x = "UMAP 1", y = "UMAP 2")
...
## Plot them all:
multiplot(tSNE_var_PAGsubdivisions, tSNE_var_PAGsubdivisions, tSNE_var_RankWalktrap_k8, tSNE_var_JaccardLouvain_k10, cols = 2)
multiplot(tSNE_cv2_PAGsubdivisions, tSNE_cv2_RankWalktrap_k7, tSNE_cv2_JaccardLouvain_k8, tSNE_cv2_JaccardLouvain_k10, cols = 2)
multiplot(UMAP_var_PAGsubdivisions, UMAP_var_PAGsubdivisions, UMAP_var_RankWalktrap_k8, UMAP_var_JaccardLouvain_k10, cols = 2)
multiplot(UMAP_cv2_10_005_PAGsubdivisions, UMAP_cv2_10_005_RankWalktrap_k7, UMAP_cv2_10_005_JaccardLouvain_k8, UMAP_cv2_10_005_JaccardLouvain_k10, cols = 2)
multiplot(UMAP_cv2_15_001_PAGsubdivisions, UMAP_cv2_15_001_RankWalktrap_k7, UMAP_cv2_15_001_JaccardLouvain_k8, UMAP_cv2_15_001_JaccardLouvain_k10, cols = 2)
```
...
```{r}
library(pheatmap)
pheatmap(log2(ratio_var_rank_k8 + 1), 
         cluster_cols = FALSE, cluster_rows = FALSE,
         angle_col = 0, main = "Cluster Modularity (k=8) - Rank Walktrap (var)",
         color = rev(viridis::magma(100))) # color = colorRampPalette(c("white", "blue"))(100) or color = rev(viridis::magma(100))

pheatmap(log2(ratio_var_jaccard_k10 + 1), 
         cluster_cols = FALSE, cluster_rows = FALSE,
         angle_col = 0, main = "Cluster Modularity (k=10) - Jaccard Louvain (var)",
         color = rev(viridis::magma(100))) # color = colorRampPalette(c("white", "blue"))(100) or color = rev(viridis::magma(100))

pheatmap(log2(ratio_cv2_rank_k7 + 1), 
         cluster_cols = FALSE, cluster_rows = FALSE,
         angle_col = 0, main = "Cluster Modularity (k=7) - Rank Walktrap (cv2)",
         color = rev(viridis::magma(100))) # color = colorRampPalette(c("white", "blue"))(100) or color = rev(viridis::magma(100))

pheatmap(log2(ratio_cv2_jaccard_k8 + 1), 
         cluster_cols = FALSE, cluster_rows = FALSE,
         angle_col = 0, main = "Cluster Modularity (k=8) - Jaccard Louvain (cv2)",
         color = rev(viridis::magma(100))) # color = colorRampPalette(c("white", "blue"))(100) or color = rev(viridis::magma(100))

pheatmap(log2(ratio_cv2_jaccard_k10 + 1), 
         cluster_cols = FALSE, cluster_rows = FALSE,
         angle_col = 0, main = "Cluster Modularity (k=10) - Jaccard Louvain (cv2)",
         color = rev(viridis::magma(100))) # color = colorRampPalette(c("white", "blue"))(100) or color = rev(viridis::magma(100))
```
...
```{r}
pheatmap(coassign_var_rank_k8, cluster_rows = FALSE, cluster_cols = FALSE,
         angle_col = 0, main = "Cluster Stability (k=8) - Rank Walktrap (var)",
         color = rev(viridis::magma(100)), legend_breaks = c(0, 0.2, 0.4, 0.6, 0.8, 1), # colorRampPalette(c("white", "blue"))(100)
         breaks = seq(0, 1, length = 100))

pheatmap(coassign_var_jaccard_k10, cluster_rows = FALSE, cluster_cols = FALSE,
         angle_col = 0, main = "Cluster Stability (k=10) - Jaccard Louvain (var)",
         color = rev(viridis::magma(100)), legend_breaks = c(0, 0.2, 0.4, 0.6, 0.8, 1), # colorRampPalette(c("white", "blue"))(100)
         breaks = seq(0, 1, length = 100)) 

pheatmap(coassign_cv2_rank_k7, cluster_rows = FALSE, cluster_cols = FALSE,
         angle_col = 0, main = "Cluster Stability (k=7) - Rank Walktrap (cv2)",
         color = rev(viridis::magma(100)), legend_breaks = c(0, 0.2, 0.4, 0.6, 0.8, 1), # colorRampPalette(c("white", "blue"))(100)
         breaks = seq(0, 1, length = 100))

pheatmap(coassign_cv2_jaccard_k8, cluster_rows = FALSE, cluster_cols = FALSE,
         angle_col = 0, main = "Cluster Stability (k=8) - Jaccard Louvain (cv2)",
         color = rev(viridis::magma(100)), legend_breaks = c(0, 0.2, 0.4, 0.6, 0.8, 1), # colorRampPalette(c("white", "blue"))(100)
         breaks = seq(0, 1, length = 100))

pheatmap(coassign_cv2_jaccard_k10, cluster_rows = FALSE, cluster_cols = FALSE,
         angle_col = 0, main = "Cluster Stability (k=10) - Jaccard Louvain (cv2)",
         color = rev(viridis::magma(100)), legend_breaks = c(0, 0.2, 0.4, 0.6, 0.8, 1), # colorRampPalette(c("white", "blue"))(100)
         breaks = seq(0, 1, length = 100))
```
...
plot(gaps_var$Tab[,"gap"], xlab = "Number of clusters", ylab = "Gap statistic", main = "Reasonable K for Var scenario", sub = sprintf("Suggested value of K: %s", best_k_var))
...
plot(gaps_cv2$Tab[,"gap"], xlab = "Number of clusters", ylab = "Gap statistic", main = "Reasonable K for CV2 scenario", sub = sprintf("Suggested value of K: %s", best_k_cv2))
abline(v = best_k_cv2, col = "red")
abline(v = 10, col = "aquamarine3", lty = "dotted", lwd = 2)
```

It is a good idea to run this with different seeds to verify that the results are stable. For the CV2 scenario, we can see that the suggested `k = 1` seems to be an artifact, and a value around `k = 10` or `k = 14` would perhaps be a better choice.
...
tSNE_var_kmeans <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_var_corrected_perplexity_15",
                                  colour_by = "kmeans_clusters_var", shape_by = "cell.type", 
                                  text_by = "kmeans_clusters_var") + labs(title = "tSNE (var) - K-means (centers=8)", x = "t-SNE 1", y = "t-SNE 2")
...
tSNE_cv2_kmeans <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_cv2_corrected_perplexity_15",
                                  colour_by = "kmeans_clusters_cv2", shape_by = "cell.type", 
                                  text_by = "kmeans_clusters_cv2") + labs(title = "tSNE (cv2) - K-means (centers=10)", x = "t-SNE 1", y = "t-SNE 2")
...
UMAP_var_kmeans <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_var_corrected_10_neighbors_0.01_min_dist", 
                                  colour_by = "kmeans_clusters_var", shape_by = "cell.type",
                                  text_by = "kmeans_clusters_var") + labs(title = "UMAP (var) - K-means (centers=8)", x = "UMAP 1", y = "UMAP 2")
...
UMAP_cv2_10_005_kmeans <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
                                         colour_by = "kmeans_clusters_cv2", shape_by = "cell.type",
                                         text_by = "kmeans_clusters_cv2")  + labs(title = "UMAP (cv2) - K-means (centers=10)", x = "UMAP 1", y = "UMAP 2")
...
## Plot them all:
multiplot(tSNE_var_PAGsubdivisions, tSNE_cv2_PAGsubdivisions, tSNE_var_kmeans, tSNE_cv2_kmeans, cols = 2)
multiplot(UMAP_var_PAGsubdivisions, UMAP_var_kmeans, cols = 2)
multiplot(UMAP_cv2_10_005_PAGsubdivisions, UMAP_cv2_15_001_PAGsubdivisions, UMAP_cv2_10_005_kmeans, UMAP_cv2_15_001_kmeans, cols = 2)
```
...
tSNE_var_kmeans_overcluster <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_var_corrected_perplexity_15",
                                              colour_by = "kmeans_overcluster_var", shape_by = "cell.type",
                                              text_by = "kmeans_overcluster_var") + labs(title = "tSNE (var) - K-means (centers=20)", x = "t-SNE 1", y = "t-SNE 2")

# t-SNE using PCA from HVG_cv2_logcounts
tSNE_cv2_kmeans_overcluster <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, dimred = "tSNE_cv2_corrected_perplexity_15",
                                              colour_by = "kmeans_overcluster_cv2", shape_by = "cell.type", 
                                              text_by = "kmeans_overcluster_cv2") + labs(title = "tSNE (cv2) - K-means (centers=20)", x = "t-SNE 1", y = "t-SNE 2")

# UMAP using PCA from HVG_var_logcounts
UMAP_var_kmeans_overcluster <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_var_corrected_10_neighbors_0.01_min_dist",
                                              colour_by = "kmeans_overcluster_var", shape_by = "cell.type",
                                              text_by = "kmeans_overcluster_var") + labs(title = "UMAP (var) - K-means (centers=20)", x = "UMAP 1", y = "UMAP 2")
...
UMAP_cv2_10_005_kmeans_overcluster <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
                                                     colour_by = "kmeans_overcluster_cv2", shape_by = "cell.type",
                                                     text_by = "kmeans_overcluster_cv2")  + labs(title = "UMAP (cv2) - K-means (centers=20)", x = "UMAP 1", y = "UMAP 2")
...
## Plot them all:
multiplot(tSNE_var_PAGsubdivisions, tSNE_cv2_PAGsubdivisions, tSNE_var_kmeans_overcluster, tSNE_cv2_kmeans_overcluster, cols = 2)
multiplot(UMAP_var_PAGsubdivisions, UMAP_var_kmeans_overcluster, cols = 2)
multiplot(UMAP_cv2_10_005_PAGsubdivisions, UMAP_cv2_15_001_PAGsubdivisions, UMAP_cv2_10_005_kmeans_overcluster, UMAP_cv2_15_001_kmeans_overcluster, cols = 2)
```
...
multiplot(UMAP_var_PAGsubdivisions, UMAP_cv2_15_001_PAGsubdivisions, UMAP_var_kmeans, UMAP_cv2_15_001_kmeans, cols = 2)
```
...
# Building a tree
PAG_tree_var <- hclust(PAG_dist_var, 
                       method = "ward.D2") # Agglomeration method to be used, default is "complete"
...
labels_colors(PAG_dend_var) <- c(`dmpag_VGAT` = "cornflowerblue", `dlpag_VGAT` = "cyan3", `lpag_VGAT` = "aquamarine3", `vlpag_VGAT` = "cadetblue3",
                                 `dmpag_VGluT2` = "red", `dlpag_VGluT2` = "coral2", `lpag_VGluT2` = "salmon", `vlpag_VGluT2` = "darksalmon"
                                 )[combined_fac_var][order.dendrogram(PAG_dend_var)]
plot(PAG_dend_var, main = "Dendrogram from hierarchical clustering (var)", ylab = "Height")
...
labels_colors(PAG_dend_cv2) <- c(`dmpag_VGAT` = "cornflowerblue", `dlpag_VGAT` = "cyan3", `lpag_VGAT` = "aquamarine3", `vlpag_VGAT` = "cadetblue3",
                                 `dmpag_VGluT2` = "red", `dlpag_VGluT2` = "coral2", `lpag_VGluT2` = "salmon", `vlpag_VGluT2` = "darksalmon"
                                 )[combined_fac_cv2][order.dendrogram(PAG_dend_cv2)]
plot(PAG_dend_cv2, main = "Dendrogram from hierarchical clustering (cv2)", ylab = "Height")
```
...
labels_colors(PAG_dend_var) <- PAG_clust_var_cutreeDynamic[order.dendrogram(PAG_dend_var)]
plot(PAG_dend_var, main = "Dendrogram from hierarchical clustering (var)", sub = "Dynamic Tree Cut", ylab = "Height")
...
labels_colors(PAG_dend_cv2) <- PAG_clust_cv2_cutreeDynamic[order.dendrogram(PAG_dend_cv2)]
plot(PAG_dend_cv2, main = "Dendrogram from hierarchical clustering (cv2)", sub = "Dynamic Tree Cut", ylab = "Height")
```
...
PAG_clust_var_cutree_k <- cutree(PAG_tree_var, # Use either "k" or "h"
                                 ...
                                 #h = 325) # height where the tree should be cut
table(PAG_clust_var_cutree_k)

labels_colors(PAG_dend_var) <- PAG_clust_var_cutree_k[order.dendrogram(PAG_dend_var)]
plot(PAG_dend_var, main = "Dendrogram from hierarchical clustering (var)", sub = "Tree Cut using k=8", ylab = "Height")
...
labels_colors(PAG_dend_var) <- PAG_clust_var_cutree_h[order.dendrogram(PAG_dend_var)]
plot(PAG_dend_var, main = "Dendrogram from hierarchical clustering (var)", sub = "Tree Cut using h=290", ylab = "Height")
abline(h = 290, col = "red")
...
PAG_clust_cv2_cutree_k <- cutree(PAG_tree_cv2, # Use either "k" or "h"
                                 ...
                                 #h = 260) # height where the tree should be cut
table(PAG_clust_cv2_cutree_k)

labels_colors(PAG_dend_cv2) <- PAG_clust_cv2_cutree_k[order.dendrogram(PAG_dend_cv2)]
plot(PAG_dend_cv2, main = "Dendrogram from hierarchical clustering (cv2)", sub = "Tree Cut using k=10", ylab = "Height")
...
labels_colors(PAG_dend_cv2) <- PAG_clust_cv2_cutree_h[order.dendrogram(PAG_dend_cv2)]
plot(PAG_dend_cv2, main = "Dendrogram from hierarchical clustering (cv2)", sub = "Tree Cut using h=235", ylab = "Height")
abline(h = 235, col = "red")
```
...
UMAP_var_cutreedynamic <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_var_corrected_10_neighbors_0.01_min_dist",
                                         colour_by = "cutreedynamic_clusters_var", shape_by = "cell.type",
                                         text_by = "cutreedynamic_clusters_var") + labs(title = "UMAP (var) - Dynamic Tree Cut", x = "UMAP 1", y = "UMAP 2")

UMAP_var_cutree_k <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_var_corrected_10_neighbors_0.01_min_dist",
                                    colour_by = "cutree_clusters_var_k", shape_by = "cell.type",
                                    text_by = "cutree_clusters_var_k") + labs(title = "UMAP (var) - Tree Cut (k=8)", x = "UMAP 1", y = "UMAP 2")

UMAP_var_cutree_h <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_var_corrected_10_neighbors_0.01_min_dist",
                                    colour_by = "cutree_clusters_var_h", shape_by = "cell.type",
                                    text_by = "cutree_clusters_var_h") + labs(title = "UMAP (var) - Tree Cut (h=290)", x = "UMAP 1", y = "UMAP 2")
...
UMAP_cv2_10_005_cutreedynamic <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
                                                colour_by = "cutreedynamic_clusters_cv2", shape_by = "cell.type",
                                                text_by = "cutreedynamic_clusters_cv2")  + labs(title = "UMAP (cv2) - Dynamic Tree Cut", x = "UMAP 1", y = "UMAP 2")

UMAP_cv2_10_005_cutree_k <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
                                           colour_by = "cutree_clusters_cv2_k", shape_by = "cell.type",
                                           text_by = "cutree_clusters_cv2_k")  + labs(title = "UMAP (cv2) - Tree Cut (k=10)", x = "UMAP 1", y = "UMAP 2")

UMAP_cv2_10_005_cutree_h <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
                                           colour_by = "cutree_clusters_cv2_h", shape_by = "cell.type",
                                           text_by = "cutree_clusters_cv2_h")  + labs(title = "UMAP (cv2) - Tree Cut (h=235)", x = "UMAP 1", y = "UMAP 2")
...
plot(PAG_dend_var, main = "Dendrogram from hierarchical clustering (var)", sub = "Tree Cut using k=8", ylab = "Height")
abline(h = 290, col = "red")
multiplot(UMAP_var_PAGsubdivisions, UMAP_var_cutreedynamic, UMAP_var_cutree_k, UMAP_var_cutree_h, cols = 2)
...
plot(PAG_dend_cv2, main = "Dendrogram from hierarchical clustering (cv2)", sub = "Tree Cut using k=10", ylab = "Height")
abline(h = 235, col = "red")
multiplot(UMAP_cv2_10_005_PAGsubdivisions, UMAP_cv2_10_005_cutreedynamic, UMAP_cv2_10_005_cutree_k, UMAP_cv2_10_005_cutree_h, cols = 2)
multiplot(UMAP_cv2_15_001_PAGsubdivisions, UMAP_cv2_15_001_cutreedynamic, UMAP_cv2_15_001_cutree_k, UMAP_cv2_15_001_cutree_h, cols = 2)
```
...
sil_var <- silhouette(PAG_clust_var_cutree_k, dist = PAG_dist_var)
sil_cols_var <- cluster_colors[ifelse(sil_var[,3] > 0, sil_var[,1], sil_var[,2])]
sil_cols_var <- sil_cols_var[order(-sil_var[,1], sil_var[,3])]
plot(sil_var, main = paste(length(unique(PAG_clust_var_cutree_k)), "clusters"), border = sil_cols_var, col = sil_cols_var, do.col.sort = FALSE)

sil_cv2 <- silhouette(PAG_clust_cv2_cutree_k, dist = PAG_dist_cv2)
sil_cols_cv2 <- cluster_colors[ifelse(sil_cv2[,3] > 0, sil_cv2[,1], sil_cv2[,2])]
sil_cols_cv2 <- sil_cols_cv2[order(-sil_cv2[,1], sil_cv2[,3])]
plot(sil_cv2, main = paste(length(unique(PAG_clust_cv2_cutree_k)), "clusters"), border = sil_cols_cv2, col = sil_cols_cv2, do.col.sort = FALSE)
```
...
UMAP_cv2_10_005_sc3_k7 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
                                         colour_by = "sc3_7_clusters", shape_by = "cell.type",
                                         text_by = "sc3_7_clusters")  + labs(title = "UMAP (cv2) - SC3 (k=7)", x = "UMAP 1", y = "UMAP 2")
...
UMAP_cv2_10_005_sc3_k9 <- plotReducedDim(PAG_sceset_qc_norm_filt_corr, "UMAP_cv2_corrected_10_neighbors_0.05_min_dist",
                                         colour_by = "sc3_9_clusters", shape_by = "cell.type",
                                         text_by = "sc3_9_clusters")  + labs(title = "UMAP (cv2) - SC3 (k=9)", x = "UMAP 1", y = "UMAP 2")
...
## Plot them all:
multiplot(UMAP_cv2_10_005_PAGsubdivisions, UMAP_cv2_15_001_PAGsubdivisions, UMAP_cv2_10_005_sc3_k7, UMAP_cv2_15_001_sc3_k7, cols = 2)
multiplot(UMAP_cv2_10_005_PAGsubdivisions, UMAP_cv2_15_001_PAGsubdivisions, UMAP_cv2_10_005_sc3_k9, UMAP_cv2_15_001_sc3_k9, cols = 2)
```
...
for(chosen_k in best_k) {
  # Consensus Matrix
  sc3_plot_consensus(PAG_sceset_qc_norm_filt_corr, k = chosen_k,  show_pdata = c("cell.type", "PAG.arearegistration", paste0("sc3_", chosen_k, "_clusters")))

  # Silhouette plot
  sc3_plot_silhouette(PAG_sceset_qc_norm_filt_corr, k = chosen_k)
  
  # Stability index
  sc3_plot_cluster_stability(PAG_sceset_qc_norm_filt_corr, k = chosen_k)

  # Expression panel
  sc3_plot_expression(PAG_sceset_qc_norm_filt_corr, k = chosen_k, show_pdata = c("cell.type", "PAG.arearegistration", paste0("sc3_", chosen_k, "_clusters")))
  
  # DE Genes
  sc3_plot_de_genes(PAG_sceset_qc_norm_filt_corr, k = chosen_k, p.val = 0.001,
                    show_pdata = c("cell.type", "PAG.arearegistration", paste0("sc3_", chosen_k, "_clusters")))
  
  # Marker Genes
  sc3_plot_markers(PAG_sceset_qc_norm_filt_corr, k = chosen_k, auroc = 0.8, p.val = 0.01,
                   show_pdata = c("cell.type", "PAG.arearegistration", paste0("sc3_", chosen_k, "_clusters")))
}
```

```{r}
# Try saving the plots --> Figure out the way to adjust their size so they don't get cropped
# best_k <- list(7, 9) # Set the chosen K for the following plots
# for(chosen_k in best_k) {
#   # Consensus Matrix
#   consensus <- sc3_plot_consensus(PAG_sceset_qc_norm_filt_corr, k = chosen_k,
#                                   show_pdata = c("cell.type", "PAG.arearegistration", paste0("sc3_", chosen_k, "_clusters")))
#   ggsave(paste0("sc3_consensus_k", chosen_k, ".png"), plot = consensus, limitsize = FALSE,
#          path = "D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Clustering/")
#   
#   # Silhouette plot
#   silhouette <- sc3_plot_silhouette(PAG_sceset_qc_norm_filt_corr, k = chosen_k)
#   ggsave(paste0("sc3_silhouette_k", chosen_k, ".png"), plot = silhouette, limitsize = FALSE,
#          path = "D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Clustering/")
#   
#   # Stability index
#   cluster_stability <- sc3_plot_cluster_stability(PAG_sceset_qc_norm_filt_corr, k = chosen_k)
#   ggsave(paste0("sc3_stability_k", chosen_k, ".png"), plot = cluster_stability, height = ,
#          path = "D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Clustering/")
#   
#   # Expression panel
#   expression_panel <- sc3_plot_expression(PAG_sceset_qc_norm_filt_corr, k = chosen_k,
#                                           show_pdata = c("cell.type", "PAG.arearegistration", paste0("sc3_", chosen_k, "_clusters")))
#   ggsave(paste0("sc3_expression_k", chosen_k, ".png"), plot = expression_panel, limitsize = FALSE,
#          path = "D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Clustering/")
#   
#   # DE Genes
...
#                                 p.val = 0.001,
#                                 show_pdata = c("cell.type", "PAG.arearegistration", paste0("sc3_", chosen_k, "_clusters")))
#   ggsave(paste0("sc3_DEgenes_k", chosen_k, ".png"), plot = DE_genes, limitsize = FALSE,
#          path = "D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Clustering/")
#   
#   # Marker Genes
...
#                               show_pdata = c("cell.type", "PAG.arearegistration", paste0("sc3_", chosen_k, "_clusters")))
#   ggsave(paste0("sc3_markers_k", chosen_k, ".png"), plot = markers, limitsize = FALSE,
#          path = "D:/Dropbox (UCL - SWC)/Project_transcriptomics/figures_in_progress/R_figures/Clustering/")
# }
```
...
## Step 6.5 | Compare all clustering results
As a final step, we can plot the chosen clustering solutions side by side so we can compare them and make a final decision:
```{r}
## Graph-based Clustering
multiplot(tSNE_var_PAGsubdivisions, tSNE_var_PAGsubdivisions, tSNE_var_RankWalktrap_k8, tSNE_var_JaccardLouvain_k10, cols = 2)
multiplot(tSNE_cv2_PAGsubdivisions, tSNE_cv2_RankWalktrap_k7, tSNE_cv2_JaccardLouvain_k8, tSNE_cv2_JaccardLouvain_k10, cols = 2)
...
# Dendrograms (var)
labels_colors(PAG_dend_var) <- PAG_clust_var_cutreeDynamic[order.dendrogram(PAG_dend_var)]
plot(PAG_dend_var, main = "Hierarchical clustering (var)", sub = "Dynamic Tree Cut", ylab = "Height")
labels_colors(PAG_dend_var) <- PAG_clust_var_cutree_k[order.dendrogram(PAG_dend_var)]
plot(PAG_dend_var, main = "Hierarchical clustering (var)", sub = "Tree Cut using k=8", ylab = "Height")
abline(h = 290, col = "red")
multiplot(UMAP_var_PAGsubdivisions, UMAP_var_cutreedynamic, UMAP_var_cutree_k, UMAP_var_cutree_h, cols = 2)
# Dendrograms (cv2)
labels_colors(PAG_dend_cv2) <- PAG_clust_cv2_cutreeDynamic[order.dendrogram(PAG_dend_cv2)]
plot(PAG_dend_cv2, main = "Hierarchical clustering (cv2)", sub = "Dynamic Tree Cut", ylab = "Height")
labels_colors(PAG_dend_cv2) <- PAG_clust_cv2_cutree_k[order.dendrogram(PAG_dend_cv2)]
plot(PAG_dend_cv2, main = "Hierarchical clustering (cv2)", sub = "Tree Cut using k=10", ylab = "Height")
abline(h = 235, col = "red")
# Dendrograms (cell type)
PAGarea_celltype_colors <- paste0(PAG_sceset_qc_norm_filt_corr$PAGarea_celltype)
labels_colors(PAG_dend_var) <- c(`dmpag_VGAT` = "cornflowerblue", `dlpag_VGAT` = "cyan3", `lpag_VGAT` = "aquamarine3", `vlpag_VGAT` = "cadetblue3",
                                 `dmpag_VGluT2` = "red", `dlpag_VGluT2` = "coral2", `lpag_VGluT2` = "salmon", `vlpag_VGluT2` = "darksalmon"
                                 )[PAGarea_celltype_colors][order.dendrogram(PAG_dend_var)]
plot(PAG_dend_var, main = "Hierarchical clustering (var)", sub = "Tree Cut using k=8", ylab = "Height")
abline(h = 290, col = "red")
labels_colors(PAG_dend_cv2) <- c(`dmpag_VGAT` = "cornflowerblue", `dlpag_VGAT` = "cyan3", `lpag_VGAT` = "aquamarine3", `vlpag_VGAT` = "cadetblue3",
                                 `dmpag_VGluT2` = "red", `dlpag_VGluT2` = "coral2", `lpag_VGluT2` = "salmon", `vlpag_VGluT2` = "darksalmon"
                                 )[PAGarea_celltype_colors][order.dendrogram(PAG_dend_cv2)]
plot(PAG_dend_cv2, main = "Hierarchical clustering (cv2)", sub = "Tree Cut using k=10", ylab = "Height")
abline(h = 235, col = "red")
# UMAPs and t-SNE embeddings
multiplot(UMAP_cv2_10_005_PAGsubdivisions, UMAP_cv2_10_005_cutreedynamic, UMAP_cv2_10_005_cutree_k, UMAP_cv2_10_005_cutree_h, cols = 2)
