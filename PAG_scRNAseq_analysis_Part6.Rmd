...
start_time <- Sys.time() # Takes around 2.3 hours
PAG_DESeq_set_123ab <- DESeq2::DESeq(PAG_DESeq_set_123ab, minReplicatesForReplace = Inf, sfType = "poscounts", parallel = TRUE)
DESeq2::plotDispEsts(PAG_DESeq_set_123ab)
end_time <- Sys.time()
end_time - start_time

# Once you have run `DESeq`, save the resulting file so you don't need to run it again:
saveRDS(PAG_DESeq_set_0, file = "PAG_DESeq_set_0")
