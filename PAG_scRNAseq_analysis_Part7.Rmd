      ...
      for (chosen_group in range_of_groups) {
        ...
        SNN_clusters_marker_set_summary = rbind(SNN_clusters_marker_set_summary,
                                                data.frame(marker_set = marker_set,
                                                           ...
                                                           direction = direction,
                                                           genes_FDR = sum(temp_marker_set$FDR<0.05)))
      }
    }
  }
}
...
VGAT_de_genes <- rownames(marker_set_VGAT_wilcox_all_up[marker_set_VGAT_wilcox_all_up$FDR<0.05, ]) 
VGluT2_de_genes <- rownames(marker_set_VGluT2_wilcox_all_up[marker_set_VGluT2_wilcox_all_up$FDR<0.05, ]) 
...
### 7.1.3 | Marker genes for PAG subdivisions
...
### 7.1.4 | Marker genes for PAG subdivision within cell type

### 7.1.5 | Marker genes for cell type along AP axis

### 7.1.6 | Marker genes for cell type according to VGAT or VGluT2 expression
