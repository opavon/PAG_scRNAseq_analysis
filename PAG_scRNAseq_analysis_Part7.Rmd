...
We can use the `Top` value to identify a set of genes that is guaranteed to distinguish cluster X from any other cluster. Here, we examine the top 6 genes from each pairwise comparison.
```{r}
