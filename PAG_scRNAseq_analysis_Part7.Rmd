...
# DE genes in cluster 4
metadata(PAG_sceset_qc_norm_filt_corr_clust_de)$marker_set_SC3_k4_wilcox_all_up <- rownames(marker_set_SC3_k4_4_wilcox_all_up[marker_set_SC3_k4_4_wilcox_all_up$FDR<fdr_threshold, ])
