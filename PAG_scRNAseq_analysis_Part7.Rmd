...
## Step 7.3 | simpleSingleCell Workflow - Limma-voom
...
### 7.4.3 | Creating a design matrix and contrasts
...
### 7.4.4 | Removing heteroscedascity from count data and linear modelling
...
### 7.4.5 | Examining the number of DE genes
...
### 7.4.6 | Useful graphical representations of differential expression results
...
### 7.6.1 | Kolmogorov-Smirnov test (non-parametric)
...
### 7.6.2 | Wilcox/Mann-Whitney-U Test (non-parametric)
