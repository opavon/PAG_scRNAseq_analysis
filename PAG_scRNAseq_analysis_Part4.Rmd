...
write.table(hvg_var_out_no_spikes_block_filt, file = str_c(path_for_figures, "PAG_hvg_var_out_no_spikes_block_filt.csv"), quote = FALSE, row.names = TRUE)
write.table(hvg_cv2_out_no_spikes_filt, file = str_c(path_for_figures, "PAG_hvg_cv2_out_no_spikes_filt.csv"), quote = FALSE, row.names = TRUE)
write.table(hvg_cv2_out_no_spikes_block_filt, file = str_c(path_for_figures, "PAG_hvg_cv2_out_no_spikes_block_filt.csv"), quote = FALSE, row.names = TRUE)
