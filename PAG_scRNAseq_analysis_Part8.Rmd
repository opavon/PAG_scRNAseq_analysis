...
An alternative way to explore marker genes is to load the .RDS file containing the results. This object have a slot for each comparison we carried out and will include the gene names together with their `p.value`, `FDR`, and `AUC`. We can use this to further filter and select them.
```{r}
...
nm_np_gene_list <- c("Nxph1", "Pnoc", "Adcyap1", "Nxph4", "Tac1")
...
# Define list of genes and title for plots
nm_np_gene_list_2 <- c("Drd1", "Rxfp2", "Tacr1", "Galr1", "Prokr2", "Cartpt", "Grp", "Spx", "Adra2a")
...
# Define list of genes and title for plots
asic_a2d1_gene_list <- c("Asic1", "Asic4", "Cacna1a", "Cacna2d1", "Cacna2d2")
plot_title <- "ASIC and Calcium channels"
...
# Compose plots
asic_a2d1_dotplot_vgat <- plotDots(PAG_sceset_qc_norm_filt_corr_clust_de,
                                   features = asic_a2d1_gene_list,
                                   exprs_values = "logcounts", detection_limit = 0,
                                   group = "cell.type", #"cell.type", "celltype_PAGarea", "celltype_PAGAPaxis"
                                   low_color = "white", high_color = colour_vgat,
                                   max_ave = NULL, max_detected = NULL
  ...
  labs(title = plot_title, x = NULL, y = NULL) + theme_args_dots +
  scale_y_discrete(limits = rev(asic_a2d1_gene_list)) + 
  scale_x_discrete(limits = levels(PAG_sceset_qc_norm_filt_corr_clust_de$cell.type))

asic_a2d1_dotplot_vglut2 <- plotDots(PAG_sceset_qc_norm_filt_corr_clust_de,
                                     features = asic_a2d1_gene_list,
                                     exprs_values = "logcounts", detection_limit = 0,
                                     group = "cell.type", #"cell.type", "celltype_PAGarea", "celltype_PAGAPaxis"
                                     low_color = "white", high_color = colour_vglut2,
...
asic_a2d1_dotplot_vgat_subdivisions <- plotDots(PAG_sceset_qc_norm_filt_corr_clust_de,
                                                features = asic_a2d1_gene_list,
                                                exprs_values = "logcounts", detection_limit = 0,
                                                group = "celltype_PAGarea", #"cell.type", "celltype_PAGarea", "celltype_PAGAPaxis"
                                                low_color = "white", high_color = colour_vgat,
...
asic_a2d1_dotplot_vglut2_subdivisions <- plotDots(PAG_sceset_qc_norm_filt_corr_clust_de,
                                                  features = asic_a2d1_gene_list,
                                                  exprs_values = "logcounts", detection_limit = 0,
                                                  group = "celltype_PAGarea", #"cell.type", "celltype_PAGarea", "celltype_PAGAPaxis"
                                                  low_color = "white", high_color = colour_vglut2,
...
# Plot them
asic_a2d1_dotplot_vgat
asic_a2d1_dotplot_vglut2
asic_a2d1_dotplot_vgat_subdivisions
asic_a2d1_dotplot_vglut2_subdivisions

# Save plots
ggsave(filename = str_c(date, "_dotplot_asic_a2d1_vgat.pdf"),
       plot = asic_a2d1_dotplot_vgat,
       device = "pdf", # or one of "eps", "ps", "tex" (pictex), "pdf", "jpeg", "tiff", "png", "bmp", "svg" or "wmf" (windows only).
       path = str_c(path_for_figures, "/dotplots"),
       width = 4, height = 4, units = "in", dpi = 300,
       family = "Arial", bg = "transparent"
       )
ggsave(filename = str_c(date, "_dotplot_asic_a2d1_vglut2.pdf"),
       plot = asic_a2d1_dotplot_vglut2,
       device = "pdf", # or one of "eps", "ps", "tex" (pictex), "pdf", "jpeg", "tiff", "png", "bmp", "svg" or "wmf" (windows only).
       path = str_c(path_for_figures, "/dotplots"),
       width = 4, height = 4, units = "in", dpi = 300,
       family = "Arial", bg = "transparent"
       )
ggsave(filename = str_c(date, "_dotplot_asic_a2d1_vgat_subdivisions.pdf"),
       plot = asic_a2d1_dotplot_vgat_subdivisions,
       device = "pdf", # or one of "eps", "ps", "tex" (pictex), "pdf", "jpeg", "tiff", "png", "bmp", "svg" or "wmf" (windows only).
       path = str_c(path_for_figures, "/dotplots"),
       width = 8, height = 4, units = "in", dpi = 300,
       family = "Arial", bg = "transparent"
       )
ggsave(filename = str_c(date, "_dotplot_asic_a2d1_vglut2_subdivisions.pdf"),
       plot = asic_a2d1_dotplot_vglut2_subdivisions,
       device = "pdf", # or one of "eps", "ps", "tex" (pictex), "pdf", "jpeg", "tiff", "png", "bmp", "svg" or "wmf" (windows only).
       path = str_c(path_for_figures, "/dotplots"),
       width = 8, height = 4, units = "in", dpi = 300,
       family = "Arial", bg = "transparent"
