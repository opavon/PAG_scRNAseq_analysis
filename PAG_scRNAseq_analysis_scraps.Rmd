...
```
## STEP 6.5 | clusterExperiment [TO TRY]
## STEP 6.6 | bigSCale2
...
## Step 6.7 | BackSPIN - biclustering hierarchical [MATLAB/Python]
...
## Step 6.8 | SINCERA (hierarchical clustering) [not installed]
...
## Step 6.9 | pcaReduce [haven't tried, but very stochastic, does not provide a stable result] 
