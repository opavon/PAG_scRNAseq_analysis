...
```
## STEP 6.6 | clusterExperiment [not yet implemented]
## STEP 6.7 | bigSCale2
...
## Step 6.8 | BackSPIN - biclustering hierarchical [MATLAB/Python]
...
## Step 6.9 | SINCERA (hierarchical clustering) [not yet implemented]
...
## Step 6.10 | pcaReduce [not yet implemented, but very stochastic and does not provide a stable result] 
