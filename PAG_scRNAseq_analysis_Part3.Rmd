...
plot(PAG_sceset_qc$total_counts/1e6, 
     ...
     ylab="Size factor", 
     col=c("red", "black")[PAG_sceset_qc$cell.type], 
     pch=16)
...
## Step 4.1 | Identifying confounding and technical factors [NEEDS COMPLETED METADATA]
...
It is wise to check the distribution of expression values for the top HVGs to ensure that the variance estimate is not being dominated by one or two outlier cells.
```{r}
